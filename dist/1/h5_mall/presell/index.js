...
new _vue2.default({
    ...
    methods: {
        ...
        getPreSellList: function getPreSellList() {
            var _this2 = this;

            var url = _config2.default.apiHost + '/api/promotion/mpList';
            var params = {
            ...
            _vue2.default.api.get(url, params, function (res) {
                if (res.data && res.data.listObj) {
                    _this2.preSellList = _this2.preSellList.concat(res.data.listObj || []);
                    if (res.data.listObj.length < _this2.pageSize) {
                        _this2.isEnd = true;
                    }
                }
            });

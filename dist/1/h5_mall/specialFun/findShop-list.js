...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        loadShopList: function loadShopList() {
            ...
            var params = { platformId: _config2.default.platformId, keyword: decodeURI(urlParams.keyword), longitude: loc.lng, latitude: loc.lat,
            ...
            _vue2.default.api.get("/api/read/merchant/queryBaseMerchantList", params, function (result) {
                if (result.data) {
                    ...
                    _this.totalCount = data.totalNum || 0;
                    if (data.dataList && data.dataList.length > 0) {
                        _this.shopList = _this.shopList.concat(data.dataList);
                        _this.clearMarkers();
                        _this.addMarkers();
                    }
                }

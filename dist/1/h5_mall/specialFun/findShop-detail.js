...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        getShopDetail: function getShopDetail() {
            ...
            var params = { platformId: _config2.default.platformId, merchantId: urlParams.merchantId };
            _vue2.default.api.get("/api/read/merchant/getBaseMerchantShopInfo", params, function (result) {
                if (result.data) {
                    _this.currentShopInfo = result.data;
                    _this.telNum = _this.currentShopInfo.phone;
                    if (result.data.businessTime) {
                        _this.businessTime = _this.currentShopInfo.businessTime || '';
                    }
                    _this.lat = result.data.latitude;
                    _this.lng = result.data.longitude;
                }
            });
        ...
        //在地图上定位
        setLocation: function setLocation(currentShopInfo) {

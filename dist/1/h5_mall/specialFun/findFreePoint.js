...
var vm = new _vue2.default({
    ...
    computed: {
        inquireState: function inquireState() {
            if (this.ybean.cardCode && this.ybean.cardPwd) {
                return true;
            };
        }
    ...
    methods: {
        ...
        getYbean: function getYbean() {
            ...
            _vue2.default.api.postForm("/api/my/wallet/eInfo", params, function (result) {
                _this.ecard = result.data || {};
            });
        }
    }
});

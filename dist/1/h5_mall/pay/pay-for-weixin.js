...
var alipayUrl = urlParams.alipayUrl;
...
new _vue2.default({
    ...
    data: {
        isWinxin: _vue2.default.browser.weixin(),
        isPay: false
    },
    ...
    methods: {
        ...
        getOrderDetail: function getOrderDetail() {
            ...
            _vue2.default.api.get(_config2.default.apiHost + "/api/my/order/detail", params, function (res) {

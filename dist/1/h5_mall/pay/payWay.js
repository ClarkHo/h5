...
},{"../../../core/env/config.base":5,"lodash":26}],2:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":27}],3:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":27}],4:[function(require,module,exports){
"use strict";
 ...
 */
var regexCardnum = /^(\d{4}\s){0,3}(\d{0,4})$/;
var regexCardNum = /^(\d{4}\s){3}\d{4}$/;
...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiDialog: _uiDialog2.default },
    data: {
        ...
        isPaying: false,
        paymentThirdparty: '',
        returnUrl: _vue2.default.utils.getPayBackUrl(urlParams.orderCode),
        openId: '',
        cancelTime: '',
        cancelTimeStr: '',
        timer: null,
    ...
    watch: {
        payYCard: function payYCard(newValue) {
            if (!newValue) {
                this.resetNum();
                this.cardPwd.value = '';
            }
    ...
    methods: {
        isEUAvaliable: function isEUAvaliable() {
            var self = this;
            _vue2.default.api.get(_config2.default.apiHost + "/api/cashier/lyfSupportPayment", null, function (res) {
                if (res.data) {
        ...
        addEcard: function addEcard() {
            var _this = this;

            if (!this.cardCode.value) {
                _vue2.default.utils.showTips("请输入卡号");
                return;
            }
            if (!regexCardNum.test(this.cardCode.value)) {
                _vue2.default.utils.showTips('卡号格式错误');
                return;
            }
            if (!this.cardPwd.value) {
                _vue2.default.utils.showTips("请输入密码");
                return;
            }

            var params = { cardCode: this.cardCodeValue, cardPwd: this.cardPwd.value, platformId: this.platformId };
            _vue2.default.api.postForm("/api/my/wallet/bindECard", params, function (result) {
                _this.payYCard = false;
                _vue2.default.utils.showTips("成功添加伊点卡");
                //重置状态
                _this.cardCodeValue = "";
                _this.cardCode.value = "";
                _this.cardPwd.value = "";
                _this.status = 1;
                // this.getAccountSummary();
            }, function (result) {
                if (result.code == 50) {
                    _vue2.default.utils.showTips("绑定伊点卡失败");
                }
            });
        },
        ...
        getAccountSummary: function getAccountSummary() {
            ...
            _vue2.default.api.get(_config2.default.apiHost + "/api/my/wallet/summary", params, function (res) {
                _this2.accountSummary = res.data;
                if (res.data && res.data.yCardBalance !== null) {
                    _this2.yCardBalanceState = true;
                }
            });
        },
        //加载用户订单数据
        loadOrderDetail: function loadOrderDetail() {
            ...
            _vue2.default.api.get(url, params, function (result) {
                if (result.data.paymentAmount == 0) {
                    _vue2.default.utils.showTips('支付成功');
                    setTimeout(function () {
                        location.replace("/pay/pay-success.html?orderCode=" + orderCode);
                    }, 500);
                }
                _this3.order = result.data || _this3.order;
                _this3.cancelTime = _this3.order.cancelTime;
                _this3.timeCountDownBegin();
                //跟踪云
                // try {
        ...
        // 获取支付方式
        getPayGateway: function getPayGateway() {
            var _this4 = this;

            var url = _config2.default.apiHost + '/api/checkout/getPayGateway';
            var params = {
                companyId: _vue2.default.mallSettings.getCompanyId(),
                platformId: _config2.default.platformId,
                ut: this.ut,
            ...
            function filterThirdparty(arr) {
                if (arr.length > 0) {
                    for (var i = 0; i < arr.length; i++) {
                        "use strict";
                        if (!_vue2.default.browser.weixin() && arr[i].paymentThirdparty.indexOf('微信') >= 0) {
                            arr.splice(i, 1);
                        }
                        if (_vue2.default.browser.weixin() && arr[i].paymentThirdparty.indexOf('支付宝') >= 0) {
                            arr.splice(i, 1);
                        }
                    }
                }
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                _this4.payGateWays = res.data.payGatewayList || _this4.payGateWays;
                _this4.commonPayGatewayList = res.data.commonPayGatewayList || _this4.commonPayGatewayList;
                //如果在非微信端有微信支付,需要过滤掉
                filterThirdparty(_this4.payGateWays);
                filterThirdparty(_this4.commonPayGatewayList);
            });
        },
        //支付前确认库存
        payBeforeStock: function payBeforeStock(pay) {
            var _this5 = this;

            var url = _config2.default.apiHost + '/back-order-web/restful/order/validateWarehouseStock.do';
            var params = {
                ut: this.ut,
                orderCode: this.orderCode
            };
        ...
        // LYF-去支付
        createPay: function createPay(pay) {
            var _this6 = this;
            ...
            if (pay.paymentThirdparty.indexOf('微信') > -1 && !this.openId) {
                setTimeout(function () {
                    _this6.createPay(pay);
                }, 300);
                return;
            }

            var url = _config2.default.apiHost + "/api/cashier/createPay";
            var params = {
                ut: this.ut,
            ...
            _vue2.default.api.postForm(url, params, function (result) {
                if (result.data) {
                    if (_this6.paymentThirdparty.indexOf('支付宝') > -1) {
                        if (_vue2.default.browser.weixin()) {
                            window.location.href = '/pay/pay-for-weixin.html?orderNo=' + _this6.orderCode + '&alipayUrl=' + encodeURIComponent(result.data.paymentMessage.od);
                        } else {
                            window.location.href = result.data.paymentMessage.od;
                        }
                    } else if (_this6.paymentThirdparty.indexOf('微信') > -1) {
                        WeixinJSBridge.invoke('getBrandWCPayRequest', {
                            ...
                            if (res.err_msg == "get_brand_wcpay_request:ok") {
                                location.href = _this6.returnUrl;
                            } else {
                                //alert('失败');
                            }
                        });
                    } else if (_this6.paymentThirdparty.indexOf('银联') > -1) {
                        _this6.payJumpUrl = result.data.paymentMessage.od;
                        $('#submitForm').attr('action', _this6.payJumpUrl).submit();
                    }
                }
            }, function (res) {});
        },
        ...
        pay: function pay() {
            ...
            if (this.paymentThirdparty.indexOf('银联') > -1) {
                ...
                _vue2.default.api.postForm(url, params, function (result) {
                    if (result.data) {
                        if (_this7.paymentThirdparty.indexOf('支付宝') > -1) {
                            if (_vue2.default.browser.weixin()) {
                                window.location.href = '/pay/pay-for-weixin.html?orderNo=' + _this7.orderCode + '&alipayUrl=' + encodeURIComponent(result.data.od);
                            } else {
                                window.location.href = result.data.od;
                            }
                        } else if (_this7.paymentThirdparty.indexOf('微信') > -1) {
                            WeixinJSBridge.invoke('getBrandWCPayRequest', {
                                ...
                                if (res.err_msg == "get_brand_wcpay_request:ok") {
                                    location.href = _this7.returnUrl;
                                } else {
                                    //alert('失败');
                                }
                            });
        ...
        // 获取openId
        getOpenIdByCode: function getOpenIdByCode(fn) {
            var _this8 = this;

            var url = _config2.default.apiHost + "/api/weixin/getWxPayOpenIdByCode";
            var params = {
                code: urlParams.code
            };
            _vue2.default.api.get(url, params, function (res) {
                _this8.openId = res.data.data;
            });
        },
        ...
        timeCountDownBegin: function timeCountDownBegin() {
            var _this9 = this;

            var timer = setInterval(function () {
                if (_this9.cancelTime > 0) {
                    _this9.timeCountDown();
                } else {
                    if (_this9.order.orderStatus == 1) {
                        clearInterval(timer);
                        _this9.sysCancelOrder();
                        $.tips({
                            content: '该订单已失效',
                            stayTime: 2000,
                            type: "warn"
                    ...
                    } else if (_this9.order.orderStatus == 10) {
                        location.replace('/my/order-detail.html?pay=1&orderCode=' + orderCode);
                    } else {
                        location.replace("/pay/pay-success.html?orderCode=" + orderCode);
                    }
        ...
        //系统取消订单
        sysCancelOrder: function sysCancelOrder() {
            if (!this.orderCode) {
                return;
            }
            var params = {
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/my/order/cancel", params, function (res) {});
        },
        ...
        getHelpPayWay: function getHelpPayWay() {
            var _this10 = this;

            var params = {
                channelType: 1
            };
            _vue2.default.api.postForm("/opay-web/paymentConfig/getPayChannel.do", params, function (res) {
                if (res.data && res.data.length >= 0) {
                    _this10.helpPayWay = res.data[0];
                    _this10.helpPayWayState = true;
                }
            });
        },
        // 获取分享信息
        getShareInfo: function getShareInfo() {
            ...
            _vue2.default.api.postForm("/api/share/shareInfo", params, function (res) {
                _this11.shareConfig = {
                ...
                _this11.QRcodeState = true;

                // 微信分享
                _vue2.default.weixin.weixinShareOnlyFriend(_this11.shareConfig);
            });
        },
        /*  亲密付 END */
        showEUPop: function showEUPop(eupay) {
            this.yOrePay = eupay;
            this.yOrePayShow = true;
        },
        EAndUPay: function EAndUPay() {
            var self = this;
            var params = {
                ut: self.ut,
            ...
            _vue2.default.api.postForm("/api/cashier/payByCard", params, function (res) {
...
},{"../../../env/config.js":1,"../../components/ui-dialog.vue":2,"../../components/ui-header.vue":3,"vue":undefined}],5:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":7}],6:[function(require,module,exports){
...
},{"../core-js/object/define-property":6}],8:[function(require,module,exports){

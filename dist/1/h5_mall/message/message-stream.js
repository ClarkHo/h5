...
var vm = new _vue2.default({
    ...
    methods: {
        getMsgList: function getMsgList() {
            ...
            _vue2.default.api.get("/api/social/vl/message/getMsgList", params, function (result) {
                if (result.data) {
                    if (result.data.data) {
                        if (result.data.data.length > 0) {
                            _this2.msgList = _this2.msgList.concat(result.data.data);
                            if (result.data.data.length < _this2.pageSize && result.data.data.length !== 0) {
                                _this2.isEnd = true;
                            }
        ...
        goLink: function goLink(msg) {
            if (msg.h5Url == '' && msg.appUrl == '') {
                return;
            }
            if (_vue2.default.browser.isApp()) {
                if (msg.appUrl) {
                    window.location.href = msg.appUrl;
                }
            } else {
                if (msg.h5Url) {
                    window.location.href = msg.h5Url;
                }
            }
        }

...
},{"vue":undefined,"vue-hot-reload-api":4}],2:[function(require,module,exports){
"use strict";
...
new _vue2.default({
    ...
    created: function created() {
        this.getRoute(), this.checkHasvolunteer();
    },
    methods: {
        //登录成功返回首页
            ...
            _vue2.default.api.postForm("/ouser-center/api/user/info/detail.do", params, function (res) {
                ...
                if (res.code == 0) {
                    if (res.data.memberInfo.memberTypeName == "内购会员") {
                        _this2.step = 2;
                        _this2.username = res.data.memberInfo.realName;
                        if (!_this2.username) {
                            _this2.username = res.data.userInfo.inviteUserMobile;
                        }
...
},{"../components/ui-header.vue":1,"../config/default.js":2,"vue":undefined}],4:[function(require,module,exports){
var Vue // late bind

...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        bindMobile: function bindMobile() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                _this.bindState = res.data.result;
                if (_this.bindState) {
                    $.tips({
                        content: '绑定成功',
                        stayTime: 2000,
                    ...
                    _vue2.default.auth.setUserToken(_this.ut);
        ...
        unionLogin: function unionLogin() {
            ...
            _vue2.default.api.postForm('' + "/ouser-web/unionLogin/login.do", params, function (result) {
                _this2.ut = result.ut;
                _this2.bindMobile();
            });
        }

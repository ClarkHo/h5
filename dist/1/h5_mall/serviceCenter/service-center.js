...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":27,"vueify/lib/insert-css":28}],3:[function(require,module,exports){
"use strict";
...
new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default, UiFooter: _uiFooter2.default
    },
    data: {
        PicListDolp: [],
        ServicePictoCms: [],
    ...
    methods: {
        //获取轮播的广告
        getPicListDolp: function getPicListDolp() {
            var _this = this;
            ...
            _vue2.default.api.get(url, param, function (res) {
                if (res.code == 0) {
                    _this.PicListDolp = res.data.slider_pic;
                    _this.ServicePictoCms = res.data.service_cms;
                    _this.serviceCenter_afterSales_adCode = res.data.serviceCenter_afterSales_adCode;
                    _this.serviceCenter_newBuy_adCode = res.data.serviceCenter_newBuy_adCode;
                    /*Vue.nextTick(() => {
...
},{"../../../env/config.js":1,"../../components/ui-footer.vue":2,"../../components/ui-header.vue":3,"vue":undefined}],5:[function(require,module,exports){
"use strict";

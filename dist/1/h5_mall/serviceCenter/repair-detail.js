...
},{"vue":undefined,"vue-hot-reload-api":31}],3:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":31}],4:[function(require,module,exports){
...
},{"../../env/config.js":1,"./ui-actionsheet-pop.vue":2,"babel-runtime/core-js/json/stringify":8,"vue":undefined,"vue-hot-reload-api":31,"vueify/lib/insert-css":32}],5:[function(require,module,exports){
"use strict";
...
exports.default = {
    ...
    watch: {},
    methods: {
        clickEvent: function clickEvent(order) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3306fb39", module.exports)
  } else {
    hotAPI.update("_v-3306fb39", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":undefined,"vue-hot-reload-api":31}],6:[function(require,module,exports){
"use strict";
...
var _uiOrderListSimple = require("../../components/ui-order-list-simple.vue");

var _uiOrderListSimple2 = _interopRequireDefault(_uiOrderListSimple);
...
new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default, uiOrderListSimple: _uiOrderListSimple2.default, UiOrderBtn: _uiOrderBtn2.default
    },
    data: {
        ut: _vue2.default.auth.getUserToken(),
        repairDetail: {}, //维修详情
    ...
    methods: {
        getRepairDetail: function getRepairDetail() {
            ...
            var url = _config2.default.apiHost + '/back-order-web/restful/afterSales/queryReturnMaintainInfo.do';
            var params = {
                ut: this.ut,
                returnId: urlParams.id
            };
            _vue2.default.api.postForm(url, params, function (res) {
                _this.repairDetail = res.data;
                if (res.data.returnCode) {
                    _this.getConectOrder();
                }
            });
        },
        getConectOrder: function getConectOrder() {
            var _this2 = this;

            var url = _config2.default.apiHost + '/back-order-web/restful/order/queryRelationOrderList.do';
            var params = {
                ut: this.ut,
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                if (res.data) {
                    ...
                    _this2.connectOrder = res.data.listObj || [];
                }
            });
        },
        cancelApply: function cancelApply() {
            var url = _config2.default.apiHost + '/api/my/orderAfterSale/cancelReturnProduct';
            var params = {
                ut: this.ut,
                companyId: _vue2.default.mallSettings.getCompanyId(),
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                _vue2.default.utils.showTips('取消成功');
                setTimeout(function () {
                    history.back();
                }, 500);
            });
...
},{"../../../env/config.js":1,"../../components/ui-header.vue":3,"../../components/ui-order-btn.vue":4,"../../components/ui-order-list-simple.vue":5,"vue":undefined}],7:[function(require,module,exports){
"use strict";

...
new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default, uiOrderListSimple: _uiOrderListSimple2.default, UiAftersaleList: _uiAftersaleList2.default
    },
    data: {
    ...
    methods: {
        ...
        getOrderList: function getOrderList(flag, search) {
            var _this = this;

            if (this.loaded) return;
            var url = _config2.default.apiHost + '/back-order-web/restful/order/queryOrderList.do';
            if (search) {
                this.pageNo = 1;
            }
            var params = {
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                ...
                if (res.data.total == 0 && search) {
                    _vue2.default.utils.showTips('抱歉，没有找到你要的结果');
                }
                ...
                res.data.listObj.forEach(function (item) {
                    ...
                    item.orderItemListOutputVOList.forEach(function (v) {
                ...
                if (flag) {
                    _this.orderList = res.data.listObj || [];
                } else {
                    _this.orderList = _this.orderList.concat(res.data.listObj || []);
                }
            });
        },
        //获取维修进度列表
        getProcessList: function getProcessList(flag, search) {
            var _this2 = this;

            if (this.loaded) return;
            var url = _config2.default.apiHost + '/api/my/orderAfterSale/afterSaleList';
            if (search) {
                this.pageNo = 1;
            }
            var params = {
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                ...
                res.data.orderRefundVOs.forEach(function (item) {
                    item.titleName = item.merchantName;
                    item.titleStatus = item.statusDescribe;
                    item.afterSalesProductVOs.forEach(function (v) {
                        v.picUrl = v.productPicPath;
                    });
                ...
                if (flag) {
                    _this2.orderList = res.data.orderRefundVOs || [];
                } else {
                    _this2.orderList = _this2.orderList.concat(res.data.orderRefundVOs || []);
                }
            });
        },
        switchTab: function switchTab(type) {
            ...
            // this.sysSource = type;
            _vue2.default.set(this, 'sysSource', type);
            this.pageNo = 1;
            this.orderList = [];
            switch (type) {
                case 'apply':
        ...
        goRepair: function goRepair(order) {
            // console.log(order);
            if (this.sysSource == 'apply') {
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this3.totalNum > _this3.orderList.length && !_this3.loaded) {
                _this3.pageNo += 1;
                switch (_this3.sysSource) {
                    case 'apply':
                        _this3.getOrderList();
                        break;
                    case 'process':
                        _this3.getProcessList();
                        break;
...
},{"../../../env/config.js":1,"../../components/ui-aftersale-list.vue":2,"../../components/ui-header.vue":3,"../../components/ui-order-list-simple.vue":4,"vue":undefined}],6:[function(require,module,exports){
"use strict";

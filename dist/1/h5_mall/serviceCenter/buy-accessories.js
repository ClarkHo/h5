...
new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.totalNum > _this.orderList.length) {
                _this.pageNo += 1;
    ...
    methods: {
        ...
        getOrderList: function getOrderList(flag) {
            ...
            _vue2.default.api.get(url, params, function (res) {
                ...
                _this3.totalNum = res.data.totalCount;
                if (flag) {
                    _this3.orderList = res.data.orderList || [];
                } else {
                    _this3.orderList = _this3.orderList.concat(res.data.orderList || []);
                }

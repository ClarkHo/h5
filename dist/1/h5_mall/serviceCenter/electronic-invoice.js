...
new _vue2.default({
    ...
    methods: {
        getSearchList: function getSearchList() {
            ...
            var url = _config2.default.apiHost + "/api/my/order/list";
            ...
            _vue2.default.api.get(url, param, function (res) {
                ...
                return function () {
                    this.orderList = [];
                    _vue2.default.util.showTips('抱歉，没有找到你要的结果');
                };
            });
        },
        getOrderList: function getOrderList(flag) {
            var _this2 = this;
            ...
            _vue2.default.api.get(url, params, function (res) {
                ...
                _this2.totalNum = res.data.totalCount;
                if (flag) {
                    _this2.orderList = res.data.orderList || [];
                } else {
                    _this2.orderList = _this2.orderList.concat(res.data.orderList || []);
                }
            });
        },
        ...
        preview: function preview(e) {
            ...
            _vue2.default.api.get(url, param, function (res) {
                ...
                if (!res.data.invoice.pdfImgUrl) {
                    _vue2.default.utils.showTips("发票还在来的路上，请耐心等候");
                } else {

...
new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default, uiFileUpload: _uiFileUpload2.default
    },
    data: {
    ...
    methods: {
        getRepairDetail: function getRepairDetail() {
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                if (res.data) {
                    ...
                    _this.choosedPro = res.data.returnItems[0];
                    try {
                        _this.chooseType = {
                    ...
                    _this.describe = res.data.returnRemark;
                    res.data.returnPics.forEach(function (item) {
                        _this.imgBox.push(item.picUrl);
                    });
                }
            });
        },
        getOrderObj: function getOrderObj(flag) {
            var _this2 = this;

            var url = _config2.default.apiHost + '/back-order-web/restful/order/queryApplyMaintainGoodsInfo.do';
            var params = {
                ut: this.ut,
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                if (res.data) {
                    _this2.orderObj = res.data;
                }
            });
        },
        choosePro: function choosePro(pro) {
            if (!pro.guaranteeDays || pro.guaranteeDays < 0 || pro.canReturnNumber < 1) {
                _vue2.default.utils.showTips('该商品不支持维修');
                return;
            }
            this.choosedPro = pro;
            if (!this.choosedPro.choosedNum) {
                _vue2.default.set(this.choosedPro, 'choosedNum', 1);
            }
            this.step = 2;
        },
        back: function back() {
        ...
        getReturnReason: function getReturnReason() {
            var _this3 = this;

            var url = _config2.default.apiHost + '/back-order-web/restful/afterSales/queryReturnReason.do';
            var params = {
                ut: this.ut,
                type: 1 //1、维修
            };
            _vue2.default.api.postForm(url, params, function (res) {
                if (res.data) {
                    _this3.returnReasonList = res.data.returnReasonVOList;
                }
            });
        },
        changeNum: function changeNum(flag) {
            if (urlParams.id) {
                _vue2.default.utils.showTips('暂不支持修改数量');
                return;
            }
            if (flag) {
                if (this.choosedPro.choosedNum < this.choosedPro.canReturnNumber) {
                    _vue2.default.set(this.choosedPro, 'choosedNum', this.choosedPro.choosedNum + 1);
                } else {
                    _vue2.default.utils.showTips('达到可维修上限');
                }
            } else {
        ...
        getAllAddress: function getAllAddress() {
            ...
            _vue2.default.api.postForm(_config2.default.ouserHost + '/ouser-web/address/getAllAddressForm.do', params, function (res) {
                ...
                _this4.noAddress = _this4.address.length == 0;

                _this4.address.forEach(function (item) {
                    if (item.defaultIs == 1) {
                        _vue2.default.set(item, "checked", true);
                        _this4.choosedAddress = item;
                    } else {
        ...
        //选择收货地址
        choseAddress: function choseAddress(add) {
        ...
        applyMaintain: function applyMaintain() {
            /**
             * urlParams.id,表示是修改申请
             */
            if ($.isEmptyObject(this.chooseType)) {
                _vue2.default.utils.showTips('请选择故障类型');
                return;
            }

            var url = _config2.default.apiHost + (urlParams.id ? '/back-order-web/restful/afterSales/updateSoReturn.do' : '/back-order-web/restful/afterSales/applyMaintainSoReturn.do');
            var params = {
                ut: this.ut,
                type: 11, //维修类型
                returnProductListStr: (0, _stringify2.default)([{
                ...
                picListStr: (0, _stringify2.default)(this.imgBox.map(function (item) {
                    return { url: item };
                })),
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                _vue2.default.utils.showTips('提交申请成功');
                setTimeout(function () {
                    history.back();
                }, 1000);
            });
...
},{"../../../env/config.js":1,"../../components/ui-file-upload.vue":2,"../../components/ui-header.vue":3,"babel-runtime/core-js/json/stringify":6,"vue":undefined}],5:[function(require,module,exports){
"use strict";

...
},{"../../env/config.js":1,"./ui-actionsheet-pop.vue":2,"babel-runtime/core-js/json/stringify":6,"vue":undefined,"vue-hot-reload-api":29,"vueify/lib/insert-css":30}],4:[function(require,module,exports){
"use strict";
...
new _vue2.default({
    el: 'body',
    components: { UiOrderList: _uiOrderList2.default },
    data: {
        //当前用户的usertoken
        ut: _vue2.default.auth.getUserToken(),
        orders: [],
    ...
    methods: {
        ...
        searchOrders: function searchOrders() {
            ...
            _vue2.default.api.postForm(this.searchUrl, params, function (result) {
                _this.loaded = true;
                _this.totalCount = result.data.totalCount;
                _this.noOrder = _this.totalCount == 0;
                _this.orders = result.data.orderList || [];
            });
        }
...
},{"../../../env/config.js":1,"../../components/ui-order-list.vue":3,"vue":undefined}],5:[function(require,module,exports){
"use strict";

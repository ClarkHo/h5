...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getReconSelfCommissionDetail();
        });
    },
    methods: {

        //加载对账单自销佣金明细
        getReconSelfCommissionDetail: function getReconSelfCommissionDetail() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/reconSelfCommissionDetail", params, function (result) {

                // this.reconSelfCommissionDetail = result.data;
                // this.reconSelfCommissionDetailList = result.data.orderList;
                _this2.reconSelfCommissionDetail = _this2.reconSelfCommissionDetail.concat(result.data);
                _this2.reconSelfCommissionDetailList = _this2.reconSelfCommissionDetailList.concat(result.data.orderList);
            });
        }

...
new _vue2.default({
    ...
    methods: {
        ...
        init: function init() {
            ...
            _vue2.default.api.get("" + "/api/social/my/comment/init", params, function (result) {
        ...
        save: function save() {
            ...
            _vue2.default.api.postForm("" + "/api/social/my/comment/save", params, function (result) {
                $.tips({
                    content: '评价成功',
                    stayTime: 2000,
                    type: "warn"
        ...
        // 获取评论规则URL
        getCommentRule: function getCommentRule() {
            var _this3 = this;
            ...
            _vue2.default.api.get("" + "/api/dolphin/list", params, function (result) {
                _this3.commentRuleUrl = result.data.comment_rule[0];
            });
        }
    }
});

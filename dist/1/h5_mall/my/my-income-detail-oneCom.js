...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        this.reconCode = _vue2.default.utils.paramsFormat(window.location.href).reconCode;
        this.commissionLevel = _vue2.default.utils.paramsFormat(window.location.href).commissionLevel;
        //加载首屏内容
        this.getReconSubCommissionDetail();
        //滚动加载更多数据
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getReconSubCommissionDetail();
        });
    },
    methods: {
        //加载对账单子店佣金明细
        getReconSubCommissionDetail: function getReconSubCommissionDetail() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/reconSubCommissionDetail", params, function (result) {

                // this.reconSubCommissionDetail = result.data;
                // this.reconSubCommissionDetailList = result.data.orderList;

                _this2.reconSubCommissionDetail = _this2.reconSubCommissionDetail.concat(result.data);
                _this2.reconSubCommissionDetailList = _this2.reconSubCommissionDetail.concat(result.data.orderList);
            });
        }
    }
});

...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":29}],4:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":29}],5:[function(require,module,exports){
"use strict";
...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":29}],6:[function(require,module,exports){
"use strict";
...
new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiActionsheet: _uiActionsheet2.default, UiLocation: _uiLocation2.default, UiDialogCaptchas: _uiDialogCaptchas2.default },
    data: {
        //银行卡信息
        bankDetail: {
            bankId: '', //银行id
    ...
    ready: function ready() {
        this.bankCardId = _vue2.default.utils.paramsFormat(window.location.href).bankCardId;
        // 银行列表
        this.getBackList();
        // 银行卡信息
        this.getBankDetail();
    ...
    methods: {
        ...
        getBankDetail: function getBankDetail() {
            ...
            _vue2.default.api.get("" + "/api/my/bank/detail", params, function (result) {
                _this.bankDetail = result.data;
            });
        },
        //
        showImgViCode: function showImgViCode() {
        ...
        // 银行列表
        getBackList: function getBackList() {
            var _this2 = this;

            var params = {};
            _vue2.default.api.get("" + "/api/my/bank/bankList", params, function (result) {
                _this2.bankList = result.data.bankList;
            });
        },
        // 选择地区
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet.vue":2,"../../components/ui-dialog-captchas.vue":3,"../../components/ui-header.vue":4,"../../components/ui-location.vue":5,"vue":undefined}],7:[function(require,module,exports){
"use strict";

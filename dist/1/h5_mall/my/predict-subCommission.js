...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        getPredictSubCommissionList: function getPredictSubCommissionList() {
            ...
            _vue2.default.api.get("" + "/api/seller/income/predictSubCommissionList", params, function (result) {
                // this.predictSubCommissionList = result.data.subCommissionList;
                _this2.predictSubCommissionList = _this2.predictSubCommissionList.concat(result.data.subCommissionList);
            });
        }

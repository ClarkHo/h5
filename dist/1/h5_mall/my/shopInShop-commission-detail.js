...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getSettledSubCommissionOrderList();
        });
    ...
    methods: {
        ...
        //加载已结算子店佣金详情
        getSettledSubCommissionDetail: function getSettledSubCommissionDetail() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/settledSubCommissionDetail", params, function (result) {

                _this2.settledSubCommissionDetail = result.data;
            });
        },
        // 加载已结算子店佣金订单列表
        getSettledSubCommissionOrderList: function getSettledSubCommissionOrderList() {
            var _this3 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/settledSubCommissionOrderList", params, function (result) {

                // this.settledSubCommissionOrderList = result.data.subCommissionOrderList;
                _this3.settledSubCommissionOrderList = _this3.settledSubCommissionOrderList.concat(result.data.subCommissionOrderList);
            });
        }

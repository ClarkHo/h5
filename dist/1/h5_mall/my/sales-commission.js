...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getSettledSelfCommissionOrderList();
        });
        // 已结算自销佣金统计
        ...
        $('#startTime').datePicker({
            ...
            callBack: function callBack() {
                _this.startTimeStr = $('#startTime').val();
            }
        });
        $('#endTime').datePicker({
            beginyear: 2010, //判断日期类型，给出合理区间
    ...
    methods: {
        ...
        //加载已结算自销佣金订单列表
        getSettledSelfCommissionOrderList: function getSettledSelfCommissionOrderList() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/settledSelfCommissionOrderList", params, function (result) {

                // this.settledSelfCommissionOrderList = result.data.orderList;

                _this2.settledSelfCommissionOrderList = _this2.settledSelfCommissionOrderList.concat(result.data.orderList);
            });
        },
        // 搜索
        ...
        // 已结算自销佣金统计
        getSettledSelfCommissionStatistics: function getSettledSelfCommissionStatistics() {
            var _this3 = this;

            var params = {
                ut: this.ut
            };
            _vue2.default.api.get("" + "/api/seller/income/settledSelfCommissionSummary", params, function (result) {

                _this3.settledSelfCommissionStatistics = result.data;
            });
        }

...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getWithdrawRecordList();
        });
    },
    methods: {
        //提现记录列表
        getWithdrawRecordList: function getWithdrawRecordList() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/withdraw/recordList", params, function (result) {

                _this2.withdrawRecordList = result.data.recordList;
            });
        }
    }
});

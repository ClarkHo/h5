...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getPredictSelfCommissionOrderList();
        });
        // 预计自销佣金统计
    ...
    methods: {
        ...
        //加载预计自销佣金订单列表
        getPredictSelfCommissionOrderList: function getPredictSelfCommissionOrderList() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/predictSelfCommissionOrderList", params, function (result) {

                // this.predictSelfCommissionOrderList = result.data.orderList;
                _this2.predictSelfCommissionOrderList = _this2.predictSelfCommissionOrderList.concat(result.data.orderList);
            });
        },
        // 搜索
        ...
        // 预计自销佣金统计
        getPredictSelfCommissionStatistics: function getPredictSelfCommissionStatistics() {
            var _this3 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/predictSelfCommissionSummary", params, function (result) {

                _this3.predictSelfCommissionStatistics = result.data;
            });
        }

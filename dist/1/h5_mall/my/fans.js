    ...
    methods: {
        ...
        getSummary: function getSummary() {
            ...
            _vue2.default.api.get(url, param, function (res) {
                ...
                _this.customerCount = res.data.customerCount;
            }, function (res) {
        ...
        toMyFans: function toMyFans() {
            if (this.fansCount > 0) {
                window.location.href = '/my/my-fans.html';
            }
        },
        //跳转
        toMyCustomer: function toMyCustomer() {
            if (this.customerCount > 0) {
                window.location.href = '/my/my-customer.html';
            }
        }
    }
});

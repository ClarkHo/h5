...
new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiOrderList: _uiOrderList2.default, UiDropDown: _uiDropDown2.default, UiDrag: _uiDrag2.default },
    data: {
        //当前用户的usertoken
        ut: _vue2.default.auth.getUserToken(),
        //订单列表
        ...
        orderReqUrl: urlParams.seller ? _config2.default.apiHost + "/api/seller/order/list" : _config2.default.apiHost + "/api/my/order/list",
    ...
    computed: {
        dropdownTop: function dropdownTop() {
            return this.orderType == 2 ? '25' : '65';
        },
        pageConfig: function pageConfig() {
            return _config2.default.order;
        }
    },
    methods: {
        //自营，服务，其他
        changeOrderType: function changeOrderType(flag) {
            var self = this;
        ...
        loadOrders: function loadOrders() {
            ...
            _vue2.default.api.get(this.orderReqUrl, params, function (result) {
                _this3.loaded = true;
                _this3.totalCount = result.data.totalCount;
                // this.noOrder = this.totalCount == 0;
                _this3.orderList_load = _this3.orderList_load + 1;
                if (_this3.totalCount > 0) {
                    if (result.data && result.data.orderList && result.data.orderList.length > 0) {
                        ...
                        _this3.orders = _this3.orders.concat(result.data.orderList);
                        if (_this3.orders.length < _this3.pageSize && _this3.orders.length !== 0) {
                            _this3.isEnd = true;
                        }
                    } else {
                        _this3.isEnd = true;
        ...
        //切换tab
        switchTab: function switchTab(tab, bl) {
            //bl 为true则强制更新
        ...
        back: function back() {
            if (_vue2.default.browser.isApp()) {
                _vue2.default.app.back(false, true);
            } else {
        ...
        gotoIndex: function gotoIndex() {
            ...
            if (_vue2.default.browser.isApp()) {
                document.location.href = 'yh://home';
            } else {
...
},{"../../../env/config.js":1,"../../components/ui-drag.vue":3,"../../components/ui-drop-down.vue":4,"../../components/ui-header.vue":5,"../../components/ui-order-list.vue":6,"vue":undefined}],8:[function(require,module,exports){
"use strict";

...
new _vue2.default({
    ...
    filters: {
        ...
        symbolClear: function symbolClear(obj) {
    ...
    methods: {
        ...
        getUserPoint: function getUserPoint() {
            ...
            _vue2.default.api.postForm("/back-finance-web/api/commission/queryCommissionAccount.do", params, function (result) {
                ...
                if (data) {
                    _this2.amountBalance = data.availableAccountAmount;
                    _this2.amountFreezed = data.frozenAmount;
        ...
        loadPointList: function loadPointList() {
            ...
            _vue2.default.api.postForm("/back-finance-web/api/commission/queryCommissionIncomeDetail.do", params, function (result) {
                var data = result.data.commissionDetail;
                _this3.totalCount = data.total;
                if (data && data.listObj && data.listObj.length > 0) {
                    _this3.pointList = _this3.pointList.concat(data.listObj);
                }
            });
        },
        ...
        getRulesUrl: function getRulesUrl() {
            ...
            _vue2.default.api.get(url, param, function (res) {
                if (res.data.credit_rule && res.data.credit_rule[0]) {
                    _this4.rulesUrl = res.data.credit_rule[0].linkUrl;
                }
            });
        }
    }

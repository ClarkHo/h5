...
},{"../../../core/env/config.base":5,"lodash":29}],2:[function(require,module,exports){
...
},{"babel-runtime/core-js/math/log2":6,"vue":undefined,"vue-hot-reload-api":30,"vueify/lib/insert-css":31}],3:[function(require,module,exports){
"use strict";
...
new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.winningRecords.length < _this.totalCount) {
                _this.currentPage += 1;
                _this.getWinningRecords();
            }
        });
    },
    methods: {
        ...
        //获取中奖记录
        getWinningRecords: function getWinningRecords() {
            var _this3 = this;
            ...
            _vue2.default.api.get("/api/promotion/lottery/winningRecords", params, function (result) {
                _this3.loaded = true;
                if (result.data.listObj) {
                    _this3.winningRecords = _this3.winningRecords.concat(result.data.listObj || []);
                    _this3.totalCount = result.data.total || 0;
                }
            });
        },

        //普通商品加车处理
        addToCart: function addToCart(record) {
            var params = { ut: this.ut, mpId: record.awardsId, num: record.awardsNum || 1, sessionId: _vue2.default.session.getSessionId(), itemType: 3, objectId: record.recordId };
...
},{"../../../env/config.js":1,"../../components/ui-drop-down.vue":2,"../../components/ui-header.vue":3,"vue":undefined}],5:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/math/log2":9}],7:[function(require,module,exports){
...
},{"../../modules/_core":13,"../../modules/es6.math.log2":27}],10:[function(require,module,exports){
...
},{"../../modules/_core":13,"../../modules/es6.object.define-property":28}],11:[function(require,module,exports){
...
},{"./_export":17}],28:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', { defineProperty: require('./_object-dp').f });

},{"./_descriptors":15,"./_export":17,"./_object-dp":24}],29:[function(require,module,exports){
(function (global){
/**
 * @license

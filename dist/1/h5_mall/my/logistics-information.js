...
var vm = new _vue2.default({
    ...
    data: {
        ...
        backStoreFlags: {},
        packIndex: 0,
        detailUrl: urlParams.seller ? _config2.default.apiHost + "/api/seller/order/detail" : _config2.default.apiHost + "/api/my/order/detail",
        msgUrl: urlParams.seller ? _config2.default.apiHost + "/api/seller/order/logistics" : _config2.default.apiHost + "/api/my/order/newOrderMessage"
    },
    ...
    methods: {
        ...
        loadOrderDetail: function loadOrderDetail() {
            ...
            _vue2.default.api.get(this.detailUrl, params, function (result) {
                _this.childOrderList = result.data.childOrderList;
                var packages = [];
                (result.data.childOrderList || []).forEach(function (v) {
                    packages = packages.concat(v.packageList);
                });
                _this.packageList = packages;
                if (_this.packageList.length > 0) {
                    _this.getNewOrderMessage(_this.packageList[0].packageCode, 1);
                }
        ...
        getNewOrderMessage: function getNewOrderMessage(packageCode, index) {
            var _this2 = this;
            ...
            _vue2.default.api.get(this.msgUrl, params, function (result) {
                _this2.backStoreFlags[packageCode] = result.data;
                _this2.orderInfo = result.data.orderInfo;
                _this2.orderMsg = result.data.orderMessageList;
                ...
                _this2.productList = result.data.orderInfo.productList;
            });
        },
        //查询换货物流信息
        getOrderAfterSaleDelivery: function getOrderAfterSaleDelivery() {
            var _this3 = this;

            var url = _config2.default.apiHost + "/api/my/orderAfterSale/delivery";
            var params = {
                ut: this.ut,
                orderCode: this.orderCode,
            ...
            _vue2.default.api.get(url, params, function (result) {
                if (result.data && result.data.orderInfo) {
                    _this3.orderInfo = result.data.orderInfo;
                    _this3.orderMsg = result.data.orderMessageList;
                    _this3.productList = result.data.orderInfo.productList;
                }
            });
        }
    }

...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getIncomeDetailList();
        });
    },
    methods: {
        //加载收益账单列表
        getIncomeDetailList: function getIncomeDetailList() {
            var _this2 = this;
            ...
            _vue2.default.api.get("/api/seller/income/incomeList", params, function (result) {
                _this2.incomeList = _this2.incomeList.concat(result.data.incomeList);
            });
        }
    }
});

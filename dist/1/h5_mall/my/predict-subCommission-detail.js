...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        this.subDistributorId = _vue2.default.utils.paramsFormat(window.location.href).subDistributorId;
        this.subDistributorLevel = _vue2.default.utils.paramsFormat(window.location.href).subDistributorLevel;
        this.predictType = _vue2.default.utils.paramsFormat(window.location.href).predictType;
        //加载首屏内容
        this.getPredictSubCommissionOrderList();
        //滚动加载更多数据
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getPredictSubCommissionOrderList();
        });
    ...
    methods: {
        ...
        //加载预计子店佣金详情
        getPredictSubCommissionDetail: function getPredictSubCommissionDetail() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/predictSubCommissionDetail", params, function (result) {

                _this2.predictSubCommissionDetail = result.data;
            });
        },
        // 加载预计子店佣金订单列表
        getPredictSubCommissionOrderList: function getPredictSubCommissionOrderList() {
            var _this3 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/income/predictSubCommissionOrderList", params, function (result) {

                // this.predictSubCommissionOrderList = result.data.subCommissionOrderList;
                _this3.predictSubCommissionOrderList = _this3.predictSubCommissionOrderList.concat(result.data.subCommissionOrderList);
            });
        }

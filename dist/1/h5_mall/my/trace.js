...
var vm = new _vue2.default({
    ...
    computed: {
        hasViewHistory: function hasViewHistory() {
    ...
    methods: {
        ...
        loadHistory: function loadHistory() {
            ...
            if (_vue2.default.localStorage.contains(itemViewHistoryKey)) {
                this.itemViewHistory = _vue2.default.localStorage.getItem(itemViewHistoryKey);
        ...
        clearHistory: function clearHistory() {
            ...
            dialog.on("dialog:action", function (e) {
                //点击确定按钮
                if (e.index == 1) {
                    _vue2.default.localStorage.removeItem(itemViewHistoryKey);
                    _this.itemViewHistory = [];
                }
            });
        }
    }
...
},{"../../components/ui-header.vue":1,"vue":undefined}],3:[function(require,module,exports){
var Vue // late bind

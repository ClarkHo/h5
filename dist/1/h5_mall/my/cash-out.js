...
var vm = new _vue2.default({
    ...
    watch: {
        'inputWithdrawAmount': function inputWithdrawAmount() {
            var _this = this;
            ...
            _vue2.default.api.get("" + "/api/seller/withdraw/calcFee", params, function (result) {
                _this.withdrawFee = result.data.withdrawFee;
                _this.actualWithdrawAmount = result.data.actualWithdrawAmount;
            });
        }
    },
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this2.pageNo += 1;
            _this2.getBankCardList();
        });
    },
    methods: {
        //可提现金额
        UsableWithdrawAmount: function UsableWithdrawAmount() {
            var _this3 = this;

            var params = {
                ut: this.ut
            };
            _vue2.default.api.get("" + "/api/seller/withdraw/usableAmount", params, function (result) {
                _this3.usableWithdrawAmount = result.data.usableWithdrawAmount;
            });
        },
        // 提现规则 :
        getRegulation: function getRegulation() {
            var _this4 = this;

            _vue2.default.api.get("" + "/api/seller/withdraw/regulation", null, function (result) {
                _this4.regulation = result.data;
                _this4.regulation_regulationDescs = result.data.regulationDescs;
            });
        },
        // 申请提现
        ApplyWithdraw: function ApplyWithdraw() {
            ...
            _vue2.default.api.get("" + "/api/seller/withdraw/apply", params, function (result) {
                $.tips({
                    content: '提现成功',
                    stayTime: 2000,
                    type: "warn"
                });
                _this5.applyWords = '继续申请';
            } /*,(result)=>{
        ...
        getBankCardList: function getBankCardList() {
            ...
            _vue2.default.api.get("" + "/api/my/bank/list", params, function (result) {
                _this6.cardList = result.data.bankCardList;
            });
        },
        //选择银行卡

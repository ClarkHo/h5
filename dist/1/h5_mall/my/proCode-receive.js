    ...
    methods: {
        ...
        firstSend: function firstSend() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                if (res.data.needImgCaptcha) {
                    _this.startImgCode = true; // 显示图片验证码
                    _this.checkImageCode = '';
                    _this.image = res.data.image;
                    _this.imageKey = res.data.imageKey;
                } else {
                    _this.smsSend();
                }
            });
        ...
        smsSend: function smsSend() {
            ...
            var inter = setInterval(function () {
                _this2.sendCountDown--;
                _this2.sendCaptchasWords = _this2.sendCountDown + 's';
                if (_this2.sendCountDown === 0) {
                    _this2.sendCaptchasWords = '重新获取';
                    _this2.sendBtnDisabled = false;
                    _this2.sendCountDown = 60;
                    clearInterval(inter);
                }
            }, 1000);
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                //验证码发送成功
                _this2.startImgCode = false; //隐藏图片验证码窗口
                _vue2.default.utils.showTips('验证码发送成功');
            }, function (res) {
        ...
        overLimitSmsSend: function overLimitSmsSend() {
            ...
            if (!this.checkImageCode) {
                _vue2.default.utils.showTips('请输入图形验证码');
                return;
            }
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                //验证码发送成功
                _this3.startImgCode = false; //隐藏图片验证码窗口
                _this3.sendBtnDisabled = true; //禁用按钮
                _this3.sendCaptchasWords = _this3.sendCountDown + 's'; //开始即时
                var timer = setInterval(function () {
                    _this3.sendCountDown--;
                    _this3.sendCaptchasWords = _this3.sendCountDown + 's';

                    if (_this3.sendCountDown == 0) {
                        clearInterval(timer);
                        _this3.sendCaptchasWords = '重新获取';
                        _this3.sendBtnDisabled = false;
                        _this3.sendCountDown = 60;
                    }
                }, 1000);
                _vue2.default.utils.showTips(res.message);
            }, function (res) {
        ...
        // 发送验证码
        sendCaptchasCodeForm: function sendCaptchasCodeForm() {
        ...
        getImg: function getImg() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                _this4.image = res.image;
                _this4.imageKey = res.imageKey;
            });
        },
        //刷新验证码
        ...
        // 校验验证码
        checkCaptchasForm: function checkCaptchasForm() {
            var _this5 = this;
        ...
        receiveCoupon: function receiveCoupon() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                if (_this6.isECard) {
                    _this6.ECard = res.data;
                } else {
                    _this6.coupon = res.data;
                }
                _this6.step = 1;
            }, function (res) {
                // $.tips({
        ...
        //立即使用
        ImmediateUse: function ImmediateUse() {

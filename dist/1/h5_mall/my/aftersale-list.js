...
},{"../../../core/env/config.base":8,"lodash":31}],2:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":32}],3:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        //计算订单实付金额
        calcOrderAmount: function calcOrderAmount(orderRefund) {
            var amount = 0;
            var prod;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-ee4179be", module.exports)
  } else {
    hotAPI.update("_v-ee4179be", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":undefined,"vue-hot-reload-api":32}],4:[function(require,module,exports){
"use strict";
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<ul>\n    <li class=\"bgw marT10 padB10\" v-for=\"order in orders\">\n        <ul class=\"ui-list ui-list-text\">\n            <li>\n                <div class=\"ui-list-info\">\n                    <h4 class=\"ui-nowrap\">订单号：{{order.orderCode}}</h4>\n                </div>\n                <div class=\"ui-list-action\">取消订单</div>\n            </li>\n        </ul>\n        <div class=\"ui-row-flex ui-arrowlink pad12\"><!--  v-link-to=\"'/my/aftersale-detail.html?orderAfterSalesId='+order.id + '&seller=1'\" -->\n            <div class=\"ui-col ui-col-3\">\n                <img :src=\"product.productPicPath\" v-if=\"$index<3\" v-for=\"product in order.afterSalesProductVOs\" width=\"70\" height=\"70\" class=\"marR10\">\n            </div>\n            <div class=\"ui-col ui-flex ui-flex-ver ui-flex-pack-center ui-flex-align-start\">共{{order.productAmount}}件商品</div>\n        </div>\n        <ul class=\"ui-list ui-list-text ui-border-t\">\n            <li>\n                <div class=\"ui-list-info\">\n                    <h4 class=\"ui-nowrap\">&nbsp;</h4>\n                </div>\n                <div class=\"ui-list-action\">合计：<i class=\"theme\">{{order.actualReturnAmount | currency '￥'}}</i></div>\n            </li>\n        </ul>\n        \n        <!-- 卖家售后 -->\n        <!-- <div class=\"ui-flex ui-flex-pack-end pad10\">\n            <button class=\"ui-btn border-btn on f14\">拒绝售后</button>\n            <button class=\"ui-btn border-btn on f14\">同意申请</button>\n        </div> -->\n\n    </li>\n</ul>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-25203d48", module.exports)
  } else {
    hotAPI.update("_v-25203d48", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":undefined,"vue-hot-reload-api":32}],5:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":32}],6:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert(".myUl {\n  width: auto;\n}\n.div-img {\n  padding: 12px 15px;\n}\n.verLine {\n  position: relative;\n}\n.verLine:before {\n  content: '';\n  position: absolute;\n  width: 4px;\n  height: 14px;\n  background: #d6265d;\n  left: -10px;\n  top: 15px;\n}\n.more-btn-box {\n  position: absolute;\n  background-color: #d6265d;\n  border-radius: 4px;\n  z-index: 98;\n  bottom: 23px;\n  left: -24px;\n}\n.more-btn-box:after {\n  display: block;\n  position: absolute;\n  bottom: -5px;\n  left: 50%;\n  margin-left: -3px;\n  content: '';\n  width: 0;\n  height: 0;\n  border-left: 6px solid transparent;\n  border-right: 6px solid transparent;\n  border-top: 6px solid #d6265d;\n}\n.more-btn-box span {\n  display: block;\n  width: 48px;\n  margin: 0 10px;\n  padding: 0 2px;\n  line-height: 30px;\n  font-size: 12px;\n  color: #fff;\n}\n.more-btn-box span:last-child:after {\n  background-color: #d6265d;\n}\n@media screen and (max-width: 320px) {\n  .ui-btn {\n    padding: 0 2px;\n  }\n}\n.presell-pro .ui-list-thumb {\n  margin: 15px 12px 15px 0;\n  width: auto;\n  height: auto;\n}\n.presell-pro .ui-list-info {\n  padding: 15px 12px 15px 0;\n  -webkit-box-pack: start;\n  position: relative;\n}\n.presell-pro .ui-list-info p {\n  color: #333;\n  line-height: 24px;\n}\n.presell-pro .ui-list-info .name {\n  line-height: 16px;\n  height: 32px;\n}\n.presell-pro .ui-list-info .price {\n  position: absolute;\n  width: 100%;\n  bottom: 20px;\n  left: 0;\n}\n")
"use strict";
...
exports.default = {
    ...
    watch: {
        'orders': function orders(val, old) {
            if (val.length > 0) {
                val.forEach(function (item) {
                    if (item.moreFlag == undefined) {
                        _vue2.default.set(item, 'moreFlag', false);
                    }
                });
            }
        }
    ...
    methods: {
        //申请售后
        applyAfterSales: function applyAfterSales(order) {
            var _this = this;
            ...
            dialog.on("dialog:action", function (e) {
                ...
                if (e.index == 1) {
                    ...
                    _vue2.default.api.postForm("/api/my/order/confirmReceived", params, function (result) {
                        //更改订单为已完成
                        for (var i = 0; i < _this.orders.length; i++) {
                            if (_this.orders[i].orderCode == order.orderCode) {
                                _this.orders[i].orderStatus = 8;
                                _this.orders[i].orderStatusName = "已完成";
                                break;
                            }
                        }
                ...
                if (e.index == 1) {
                    ...
                    _vue2.default.api.postForm("/api/my/order/confirmReceived", params, function (result) {
                        ...
                        for (var i = 0; i < _this2.orders.length; i++) {
                            if (_this2.orders[i].orderCode == order.orderCode) {
                                _this2.orders[i].orderStatus = 8;
                                _this2.orders[i].orderStatusName = "已完成";
                                break;
                            }
                        }
        ...
        deleteOrder: function deleteOrder(order) {
            ...
            dialog.on("dialog:action", function (e) {
                ...
                //点击确定按钮
                if (e.index == 1) {
                    var params = { ut: ut, orderCode: order.orderCode, companyId: _vue2.default.mallSettings.getCompanyId() };
                    _vue2.default.api.postForm("/api/my/order/delete", params, function (result) {
                        //ui上删除该订单
                        for (var i = 0; i < _this3.orders.length; i++) {
                            if (_this3.orders[i].orderCode == order.orderCode) {
        ...
        //获取退货的跟踪云数据
        getHeimdallParams: function getHeimdallParams(order) {
            var idArr = [];
            var numArr = [];
            var prod = void 0;
        ...
        //退款
        applyRefund: function applyRefund(order, cause) {
            var _this4 = this;

            var params = { ut: ut, companyId: _vue2.default.mallSettings.getCompanyId(), orderCode: order.orderCode,
                refundReasonId: cause.key, refundRemark: cause.value };
            _vue2.default.api.postForm("/api/my/orderAfterSale/applyRefund", params, function (res) {
                //跟踪云埋点 退款
                var heimdallParams = _this4.getHeimdallParams(order);
                try {
        ...
        //打开退货原因列表
        openAfterSaleCauseList: function openAfterSaleCauseList(order) {
        ...
        selectReturnCause: function selectReturnCause(cause) {
        ...
        getAfterSaleCauseList: function getAfterSaleCauseList() {
            ...
            var params = { ut: ut, companyId: _vue2.default.mallSettings.getCompanyId(), afterSaleType: 1 };
            _vue2.default.api.get("/api/my/orderAfterSale/afterSaleCauseList", params, function (res) {
...
var _uiOrderList = require("../../components/ui-order-list.vue");

var _uiOrderList2 = _interopRequireDefault(_uiOrderList);

var _uiCancelList = require("../../components/ui-cancel-list.vue");

var _uiCancelList2 = _interopRequireDefault(_uiCancelList);

var _uiAftersaleList = require("../../components/ui-aftersale-list.vue");

var _uiAftersaleList2 = _interopRequireDefault(_uiAftersaleList);
...
new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiOrderList: _uiOrderList2.default, UiAftersaleList: _uiAftersaleList2.default, UiCancelList: _uiCancelList2.default },
    data: {
        //当前用户的usertoken
        ut: _vue2.default.auth.getUserToken(),
        //可申请售后的订单列表
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            ...
            if (_this.currentTab == 1) {
                if (_this.afterSaleableList.length < _this.totalCount) {
                    _this.pageNum += 1;
                    if (urlParams.seller) {
                        _this.getCanCancelOrders();
                    } else {
                        _this.getAfterSaleableList();
                    }
                } else {
                    _this.isEnd = true;
                }
            } else if (_this.currentTab == 2) {
                if (_this.afterSaleList.length < _this.totalCount) {
                    _this.pageNum += 1;
                    if (urlParams.seller) {
                        _this.getSellerAfterSaleList();
                    } else {
                ...
                if (_this.saleListScuss.length < _this.totalCount) {
                    _this.pageNum += 1;
                    if (urlParams.seller) {
                        _this.getSellerAfterSaleListScuss();
                    } else {
                        _this.getSaleListScuss();
                    }
                } else {
                    _this.isEnd = true;
                }
    ...
    methods: {
        ...
        //获得可申请售后的订单列表
        getAfterSaleableList: function getAfterSaleableList() {
            var _this2 = this;
            ...
            _vue2.default.api.get("/api/my/order/list", params, function (result) {
                _this2.totalCount = result.data.totalCount;
                _this2.noAfterSale = _this2.totalCount == 0;
                if (result.data && result.data.orderList && result.data.orderList.length > 0) {
                    _this2.afterSaleableList = _this2.afterSaleableList.concat(result.data.orderList);
                }
            });
        },
        ...
        getAfterSaleList: function getAfterSaleList() {
            ...
            _vue2.default.api.get("/api/my/orderAfterSale/afterSaleList", params, function (result) {
                _this3.totalCount = result.data.total;
                _this3.noAfterSale = _this3.totalCount == 0;

                if (result.data && result.data.orderRefundVOs) {
                    _this3.afterSaleList = _this3.afterSaleList.concat(result.data.orderRefundVOs);
                }
            });
        },
        //售后已完成的列表
        getSaleListScuss: function getSaleListScuss() {
            var _this4 = this;
            ...
            _vue2.default.api.get("/api/my/orderAfterSale/afterSaleList", params, function (result) {
                _this4.totalCount = result.data.total;
                _this4.noAfterSale = _this4.totalCount == 0;

                if (result.data && result.data.orderRefundVOs) {
                    _this4.saleListScuss = _this4.saleListScuss.concat(result.data.orderRefundVOs);
                }
            });
        },
        //取消订单申请列表
        getCanCancelOrders: function getCanCancelOrders() {
            var _this5 = this;
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/seller/AfterSale/list", params, function (result) {
                _this5.totalCount = result.data.total;
                _this5.noAfterSale = _this5.totalCount == 0;

                if (result.data.orderRefundVOs) {
                    _this5.afterSaleableList = _this5.afterSaleableList.concat(result.data.orderRefundVOs);
                }
            });
        },

        //查询卖家售后中列表
        getSellerAfterSaleList: function getSellerAfterSaleList() {
            var _this6 = this;
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/seller/AfterSale/list", params, function (result) {
                _this6.totalCount = result.data.total;
                _this6.noAfterSale = _this6.totalCount == 0;

                if (result.data.orderRefundVOs) {
                    _this6.afterSaleList = _this6.afterSaleList.concat(result.data.orderRefundVOs);
                }
            });
        },
        // //查询卖家售后已完成列表
        getSellerAfterSaleListScuss: function getSellerAfterSaleListScuss() {
            var _this7 = this;
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/seller/AfterSale/list", params, function (result) {
                _this7.totalCount = result.data.total;
                _this7.noAfterSale = _this7.totalCount == 0;

                if (result.data.orderRefundVOs) {
                    _this7.saleListScuss = _this7.saleListScuss.concat(result.data.orderRefundVOs);
                }
            });
        }
...
},{"../../../env/config.js":1,"../../components/ui-aftersale-list.vue":3,"../../components/ui-cancel-list.vue":4,"../../components/ui-header.vue":5,"../../components/ui-order-list.vue":6,"vue":undefined}],8:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/json/stringify":12}],10:[function(require,module,exports){
...
},{"../../modules/_core":16}],13:[function(require,module,exports){
...
},{"../../modules/_core":16,"../../modules/es6.object.define-property":30}],14:[function(require,module,exports){
...
},{"./_descriptors":18,"./_export":20,"./_object-dp":27}],31:[function(require,module,exports){
(function (global){
/**
 * @license

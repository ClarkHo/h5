...
new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.totalNum > _this.consultList.length) {
                _this.pageNo += 1;
                _this.getMyConsultList();
            }
        });
    ...
    methods: {
        //获取当前商品的问题列表
        getMyConsultList: function getMyConsultList() {
            var _this2 = this;
            ...
            _vue2.default.api.post(url, params, function (res) {
                if (res.data && res.data.listObj) {
                    ...
                    _this2.consultList = _this2.consultList.concat(res.data.listObj || []);
                }
            });
        }
    }

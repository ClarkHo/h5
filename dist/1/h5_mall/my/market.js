...
new _vue2.default({
    ...
    methods: {
        ...
        loadArticles: function loadArticles() {
            ...
            _vue2.default.api.get("" + "/api/social/live/article/list", params, function (result) {
                _this2.totalCount = result.data.total;
                _this2.noArticle = _this2.totalCount == 0;
                if (result.data.listObj.length > 0) {
                    _this2.articles = _this2.articles.concat(result.data.listObj);
                }
            });
        },
        ...
        //搜索
        marketSearch: function marketSearch() {
            if (!this.keyword) {
                $.tips({
                    content: '请输入相关文章',
                    stayTime: 2000,
        ...
        deleteArticle: function deleteArticle(id) {
            ...
            };_vue2.default.api.postForm("" + "/api/social/live/article/deletelist", params, function (result) {
                $.tips({
                    content: '删除成功',
                    stayTime: 2000,
                    type: "warn"

...
},{"../../../core/env/config.base":10,"lodash":70}],2:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":71}],4:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":71}],7:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert(".more-btn-box {\n  position: absolute;\n  background-color: #d6265d;\n  border-radius: 4px;\n  z-index: 98;\n  bottom: 23px;\n  left: -24px;\n}\n.more-btn-box:after {\n  display: block;\n  position: absolute;\n  bottom: -5px;\n  left: 50%;\n  margin-left: -3px;\n  content: '';\n  width: 0;\n  height: 0;\n  border-left: 6px solid transparent;\n  border-right: 6px solid transparent;\n  border-top: 6px solid #d6265d;\n}\n.more-btn-box span {\n  display: block;\n  width: 48px;\n  margin: 0 10px;\n  padding: 0 2px;\n  line-height: 30px;\n  font-size: 12px;\n  color: #fff;\n}\n.more-btn-box span:last-child:after {\n  background-color: #d6265d;\n}\n")
"use strict";
...
var _uiActionsheetPop = require("./ui-actionsheet-pop.vue");
...
exports.default = {
    ...
    components: { UiActionsheetPop: _uiActionsheetPop2.default },
    props: ["order", "orderListType", "refresh"],
    watch: {},
    ready: function ready() {},
    methods: {
        previewInvoice: function previewInvoice(url) {
        ...
        deleteOrder: function deleteOrder(order) {
            ...
            dialog.on("dialog:action", function (e) {
                _this2.showMoreBtn = false;
                e.preventDefault();
                e.stopPropagation();
                //点击确定按钮
                if (e.index == 1) {
                    var params = { ut: _this2.ut, orderCode: order.orderCode, companyId: _vue2.default.mallSettings.getCompanyId() };
                    _vue2.default.api.postForm("/api/my/order/delete", params, function (result) {
                        // this.loadOrderDetail();
                        _vue2.default.utils.showTips("成功删除订单");
                        setTimeout(function () {
                            _this2.goback();
                        }, 1000);
                    });
        ...
        //确认收货
        confirmReceived: function confirmReceived(order) {
            var _this3 = this;
            ...
            dialog.on("dialog:action", function (e) {
                //点击确定按钮
                if (e.index == 1) {
                    var params = { ut: _this3.ut, orderCode: order.orderCode };
                    _vue2.default.api.postForm(_config2.default.apiHost + "/api/my/order/confirmReceived", params, function (result) {
                        //更改订单为已完成
                        order.orderStatus = 8;
                    });
                    location.href = '/order/order-suc.html?orderCode=' + order.orderCode + '&mpId=' + _this3.order.childOrderList[0].orderProductList[0].mpId;
                }
            });
        },
        //选择退换货原因
        selectCause: function selectCause(cause) {
            var _this4 = this;
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/my/orderAfterSale/applyRefund", params, function (result) {
                if (typeof _this4.refresh == 'function') {
                    _this4.refresh();
                }
                $.tips({
        ...
        //获取退货原因列表
        getAfterSaleCauseList: function getAfterSaleCauseList() {
            var _this5 = this;
            ...
            _vue2.default.api.get(_config2.default.apiHost + "/api/my/orderAfterSale/afterSaleCauseList", params, function (res) {
                _this5.afterSaleCauseList = res.data.orderAfterSalesCauseVOs;
            });
        },
        openCauseList: function openCauseList() {
        ...
        prePayMent: function prePayMent(order) {
            if (!order) {
                return;
            }
            var params = {
            ...
            params.skus = (0, _stringify2.default)([skus]);
            _vue2.default.utils.quickPurchase(params, null, false);
        },
        //再次购买
        againBuy: function againBuy(order) {
            var _this6 = this;
            ...
            _vue2.default.api.get(_config2.default.apiHost + "/api/my/order/getOrderStockState", params, function (res) {
                _this6.showMoreBtn = false;
                ...
                if (res.data && res.data.availableProductList.length > 0) {
                    _this6.availableProductList = res.data.availableProductList;
                    _this6.diaShow = true;
                }
            });
        }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  module.hot.dispose(function () {
    __vueify_insert__.cache[".more-btn-box {\n  position: absolute;\n  background-color: #d6265d;\n  border-radius: 4px;\n  z-index: 98;\n  bottom: 23px;\n  left: -24px;\n}\n.more-btn-box:after {\n  display: block;\n  position: absolute;\n  bottom: -5px;\n  left: 50%;\n  margin-left: -3px;\n  content: '';\n  width: 0;\n  height: 0;\n  border-left: 6px solid transparent;\n  border-right: 6px solid transparent;\n  border-top: 6px solid #d6265d;\n}\n.more-btn-box span {\n  display: block;\n  width: 48px;\n  margin: 0 10px;\n  padding: 0 2px;\n  line-height: 30px;\n  font-size: 12px;\n  color: #fff;\n}\n.more-btn-box span:last-child:after {\n  background-color: #d6265d;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-47687654", module.exports)
  } else {
    hotAPI.update("_v-47687654", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../../env/config.js":1,"./ui-actionsheet-pop.vue":2,"babel-runtime/core-js/json/stringify":12,"vue":undefined,"vue-hot-reload-api":71,"vueify/lib/insert-css":72}],8:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":undefined,"vue-hot-reload-api":71,"vueify/lib/insert-css":72}],9:[function(require,module,exports){
"use strict";
...
var _uiOrderBtn = require("../../components/ui-order-btn.vue");

var _uiOrderBtn2 = _interopRequireDefault(_uiOrderBtn);
...
new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiActionsheetPop: _uiActionsheetPop2.default, UiScrollTop: _uiScrollTop2.default, UiActionsheet: _uiActionsheet2.default, UiCountDown: _uiCountDown2.default, UiOrderBtn: _uiOrderBtn2.default, UiGuessLike: _uiGuessLike2.default },
    data: {
        //当前用户的usertoken
        ut: _vue2.default.auth.getUserToken(),
        loggedIn: _vue2.default.auth.loggedIn(),
        kfConfig: null,
        //订单编号
        orderCode: null,
        //订单列表
        ...
        orderDetailUrl: urlParams.seller ? _config2.default.apiHost + "/api/seller/order/detail" : _config2.default.apiHost + "/api/my/order/detail",
        showReturnCause: false,
        ...
        unfold: true,
        msgUrl: _config2.default.adminHost + '/back-order-web/restful/order/deliveyInfo.do',
        showCountDown: true
    },
    ...
    computed: {
        allmpIds: function allmpIds() {
            var mpIds = [];
            this.childOrderList.forEach(function (item) {
                item.orderProductList.forEach(function (v) {
                    mpIds.push(v.mpId);
                });
            });
            return mpIds;
    ...
    methods: {
        ...
        loadOrderDetail: function loadOrderDetail() {
            ...
            _vue2.default.api.postForm(this.orderDetailUrl + "?t=" + new Date().getTime(), params, function (result) {
                _this2.order = result.data;
                if (_this2.order.invoice.invoiceContent != null) {
                    _this2.invoiceContentState = true;
                }

                _this2.childOrderList = _this2.childOrderList.concat(result.data.childOrderList);
                //获取包裹信息，进而获取包裹的快递物流信息
                _this2.getNewOrderMessage(_this2.childOrderList[0].orderCode);
                _this2.getCancleTime(_this2.order.cancelTime);

                _this2.getRecoList(_this2.allmpIds);
            }, function (result) {
                if (result.code == '11001ORDER_STATUS_ERROR' || result.code == '11001ORDER_DETAIL_ERROR') {
                    _this2.error = true;
                    _vue2.default.utils.showTips(result.message);
                    setTimeout(function () {
                        if (_vue2.default.browser.isApp()) {
        ...
        getCancleTime: function getCancleTime(cancleTime) {
            var _this = this;
            var ct = cancleTime;
        ...
        timeSwitch: function timeSwitch(time) {
            time = parseInt(time);
            if (time <= 0) time = 0;
        ...
        confirmReceived: function confirmReceived(order) {
            ...
            dialog.on("dialog:action", function (e) {
                ...
                if (e.index == 1) {
                    ...
                    location.href = '/order/order-suc.html?orderCode=' + order.orderCode + '&mpId=' + _this3.order.childOrderList[0].packageList[0].productList[0].mpId;
                }
            });
        },
        ...
        getAfterSaleCauseList: function getAfterSaleCauseList() {
            ...
            _vue2.default.api.get(_config2.default.apiHost + "/api/my/orderAfterSale/afterSaleCauseList", params, function (res) {
                _this4.afterSaleCauseList = res.data.orderAfterSalesCauseVOs;
            });
        },
        ...
        deleteOrder: function deleteOrder(order) {
            ...
            dialog.on("dialog:action", function (e) {
                ...
                //点击确定按钮
                if (e.index == 1) {
                    var params = { ut: _this6.ut, orderCode: order.orderCode, companyId: _vue2.default.mallSettings.getCompanyId() };
                    _vue2.default.api.postForm("/api/my/order/delete", params, function (result) {
                        // this.loadOrderDetail();
                        _vue2.default.utils.showTips("成功删除订单");
                        setTimeout(function () {
            ...
            _vue2.default.api.get(url, param, function (res) {
                if (res.data && res.data.dataList.length > 0) {
                    ...
                    _vue2.default.getPriceAndStock(itemIds, res.data.dataList, null, function (obj) {
                        ...
                        _this7.recoList = list;
                        _this7.resizeImgHeight();
                        _this7.initSwipe2();
                    });
                }
            }, function () {
        ...
        //申请售后
        applyAfterSale: function applyAfterSale(order) {
            var _this8 = this;
            ...
            if (this.order.orderStatus != 8) {
                ...
                dialog.on("dialog:action", function (e) {
                    //点击确定按钮
                    if (e.index == 1) {
                        var params = { ut: _this8.ut, orderCode: order.orderCode };
                        _vue2.default.api.postForm(_config2.default.apiHost + "/api/my/order/confirmReceived", params, function (result) {
                            //更改订单为已完成
                            order.orderStatus = 8;
                        });
                        location.href = '/my/aftersale.html?orderCode=' + _this8.orderCode;
                    }
                });
            }
        },
        ...
        againBuy: function againBuy(order) {
            ...
            _vue2.default.api.get(_config2.default.apiHost + "/api/my/order/getOrderStockState", params, function (res) {
                ...
                if (res.data && res.data.availableProductList.length > 0) {
                    _this9.availableProductList = res.data.availableProductList;
                    _this9.diaShow = true;
                }
            });
        },
        ...
        //获取客服配置
        getKFConfig: function getKFConfig(callback) {
            var _this11 = this;
        ...
        goCustomService: function goCustomService() {
            ...
            if (_vue2.default.browser.isApp()) {
                if (this.loggedIn) {
                    _vue2.default.app.postMessage("callcustomservice");
                } else {
                    //location.href = '/login.html?from=' + encodeURIComponent(Vue.utils.getRelatedUrl());
                    location.href = 'yh://login';
                }
            } else if (_vue2.default.browser.weixin()) {
                var dia = $.dialog({
                    title: '温馨提示',
                ...
                if (!this.loggedIn || !_vue2.default.localStorage.getItem('username')) {
                    location.href = '/login.html?from=' + encodeURIComponent(_vue2.default.utils.getRelatedUrl());
                    return;
                }
                this.getKFConfig(function (data) {
                    _this12.getUserHeadPic(function () {
                        location.href = '/kf.html?ak=' + data.appKey + '&pwd=' + data.password + '&rid=' + data.receiveId;
                    });
                });
            }
        },
        ...
        getNewOrderMessage: function getNewOrderMessage(orderCode) {
            var _this13 = this;
            ...
            _vue2.default.api.postForm(this.msgUrl, params, function (result) {
                _this13.orderMsg = result.data;
            });
        } //~ end methods

    } });

},{"../../../env/config.js":1,"../../components/ui-actionsheet-pop.vue":2,"../../components/ui-actionsheet.vue":3,"../../components/ui-count-down.vue":4,"../../components/ui-guess-like.vue":5,"../../components/ui-header.vue":6,"../../components/ui-order-btn.vue":7,"../../components/ui-scroll-top.vue":8,"babel-runtime/core-js/get-iterator":11,"babel-runtime/core-js/json/stringify":12,"vue":undefined,"vue-lazyload":undefined}],10:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":14}],11:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/get-iterator"), __esModule: true };
},{"core-js/library/fn/get-iterator":15}],12:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":16}],13:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":17}],14:[function(require,module,exports){
"use strict";
...
},{"../core-js/object/define-property":13}],15:[function(require,module,exports){
require('../modules/web.dom.iterable');
require('../modules/es6.string.iterator');
module.exports = require('../modules/core.get-iterator');

},{"../modules/core.get-iterator":65,"../modules/es6.string.iterator":68,"../modules/web.dom.iterable":69}],16:[function(require,module,exports){
...
},{"../../modules/_core":24,"../../modules/es6.object.define-property":67}],18:[function(require,module,exports){
...
},{"./_to-absolute-index":56,"./_to-iobject":58,"./_to-length":59}],22:[function(require,module,exports){
...
},{"./_export":30,"./_hide":34,"./_iter-create":39,"./_iterators":42,"./_library":43,"./_object-gpo":47,"./_redefine":51,"./_set-to-string-tag":52,"./_wks":63}],41:[function(require,module,exports){
...
},{"./_core":24,"./_global":32,"./_library":43}],55:[function(require,module,exports){
...
},{"./_add-to-unscopables":19,"./_iter-define":40,"./_iter-step":41,"./_iterators":42,"./_to-iobject":58}],67:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', { defineProperty: require('./_object-dp').f });

},{"./_descriptors":27,"./_export":30,"./_object-dp":45}],68:[function(require,module,exports){
'use strict';
...
},{"./_global":32,"./_hide":34,"./_iterators":42,"./_wks":63,"./es6.array.iterator":66}],70:[function(require,module,exports){
(function (global){
/**
 * @license

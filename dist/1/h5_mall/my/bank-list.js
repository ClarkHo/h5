    ...
    methods: {
        ...
        getBankList: function getBankList() {
            ...
            _vue2.default.api.get("" + "/api/my/bank/list", params, function (result) {
                _this2.bankList = _this2.bankList.concat(result.data.bankCardList);
            });
        },
        deleteBankDialog: function deleteBankDialog(CardId, event) {
            var _this3 = this;
            ...
            dialog.on("dialog:action", function (e) {
                //点击确定按钮
                if (e.index == 1) {
                    _this3.deleteBank(CardId);
                }
            });
        },
        deleteBank: function deleteBank(CardId) {
            var _this4 = this;
            ...
            _vue2.default.api.postForm('' + '/api/my/bank/delete', params, function (res) {
                // var el = $.tips({
                //     content: '删除成功',
                //     stayTime: 2000,
                //     type: "success"

...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        // 加载流量统计
        getTrafficInfo: function getTrafficInfo() {
            var _this2 = this;

            var params = {
                ut: this.ut
            };
            _vue2.default.api.get("" + "/obi-web/api/reportCenter/trafficInfo.do", params, function (result) {
                _this2.traffic_pv = result.data.pv;
                _this2.traffic_share = result.data.share;
                _this2.traffic_uv = result.data.uv;
                _this2.traffic_vip = result.data.vip;
            });
        },
        // 加载销售统计
        getSaleInfo: function getSaleInfo() {
            ...
            _vue2.default.api.get("" + "/obi-web/api/reportCenter/saleInfo.do", params, function (result) {
                _this3.sale_sale = result.data.sale;
            });
        },
        // 加载子铺统计
        getSubDistributorInfo: function getSubDistributorInfo() {
            var _this4 = this;

            var params = {
                ut: this.ut
            };
            _vue2.default.api.get("" + "/obi-web/api/reportCenter/subDistributorInfo.do", params, function (result) {
                _this4.subDistributor_pv = result.data.pv;
                _this4.subDistributor_sale = result.data.sale;
                _this4.subDistributor_share = result.data.share;
            });
        },
        // TOP商品 流量
        getTopProductTraffic: function getTopProductTraffic() {
            var _this5 = this;
            ...
            _vue2.default.api.get("" + "/obi-web/api/reportCenter/topProduct.do", params, function (result) {
                _this5.topProductTraffic = result.data;
                // this.topProductTraffic = this.topProductTraffic.concat(result.data);
            });
        },
        // TOP商品 销售
        getTopProductSale: function getTopProductSale() {
            var _this6 = this;
            ...
            _vue2.default.api.get("" + "/obi-web/api/reportCenter/topProduct.do", params, function (result) {
                _this6.topProductSale = result.data;
                // this.topProductSale = this.topProductSale.concat(result.data);
            });
        },
        // 子铺分页查询
        getPageSubDistributor: function getPageSubDistributor() {
            var _this7 = this;
            ...
            _vue2.default.api.get("" + "/obi-web/api/reportCenter/pageSubDistributor.do", params, function (result) {
                _this7.pageSubDistributor = result.data;

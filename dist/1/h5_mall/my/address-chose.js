...
},{"../../env/config.js":1,"./ui-header.vue":3,"./ui-location.vue":4,"vue":undefined,"vue-hot-reload-api":65}],3:[function(require,module,exports){
"use strict";
...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":65}],5:[function(require,module,exports){
"use strict";
...
//当前订单选中的收货地址
var receiverId = urlParams.r_id;
var receiverStatus = urlParams.receiverStatus;
/**
 * 使用地址选择的场景scene
 * order - 在确认订单时使用，默认方式
 * lottery - 领取奖品时选择地址
 */
var scene = urlParams.scene || "order";

new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default,
        UiAddress: _uiAddress2.default
    },
    data: {
        address: [], //地址列表
    ...
    methods: {
        ...
        getAllAddress: function getAllAddress() {
            ...
            _vue2.default.api.postForm(_config2.default.ouserHost + '/ouser-web/address/getAllAddressForm.do', params, function (res) {
                ...
                _this.noAddress = _this.address.length == 0;

                var addr;
                for (var i = 0; i < _this.address.length; i++) {
                    addr = _this.address[i];
                    //如果已经有收货地址
                    if (receiverId) {
        ...
        //保存地址 跳转至订单页
        saveReceiver: function saveReceiver(receiverId) {
        ...
        //回领奖页面
        backLottery: function backLottery(id) {
...
},{"../../../env/config.js":1,"../../components/ui-address.vue":2,"../../components/ui-header.vue":3,"babel-runtime/core-js/get-iterator":7,"vue":undefined}],6:[function(require,module,exports){
"use strict";

...
},{"../../../core/env/config.base":4,"lodash":27}],2:[function(require,module,exports){
"use strict";
...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            ...
            if (!_this.showSearchPop) {
                if (_this.getCurrentTab() == 0) {
                    if (_this.merchList.length < _this.totalCount) {
                        _this.pageNo += 1;
                        _this.getProductList();
                    } else if (_this.merchList.length >= _this.totalCount) {
                        _this.showNoMore = true;
                    }
                } else {
                    if (_this.recommendList.length < _this.totalCountR) {
                        _this.rePageNo += 1;
                        _this.getRecommendList();
                    } else if (_this.merchList.length >= _this.totalCountR) {
                        _this.showNoMoreR = true;
                    }
                }
            }
        });
    ...
    methods: {
        //获取可推荐商品
        getProductList: function getProductList(isInit) {
            var _this2 = this;
            ...
            _vue2.default.api.get("/api/seller/product/list", params, function (result) {
                _this2.loaded = true;
                ...
                if (result.data && result.data.productList instanceof Array && result.data.productList.length > 0) {
                    _this2.merchList = _this2.merchList.concat(result.data.productList);
                }

                //排序列表
                if (result.data.sortByList) {
                    _this2.sortByList = result.data.sortByList;
                } else {
                    _this2.sortByList = [];
                }
                //品牌列表
                if (_this2.brandList.length == 0) {
                    _this2.brandList = result.data.brandResult || [];
                    _this2.brandListBak = (0, _stringify2.default)(_this2.brandList);
                    _this2.brandList.forEach(function (v) {
                        "use strict";

                        if (_this2.selectedBrandIds.indexOf(v.id.toString()) >= 0) {
                            v.checked = true;
                        } else {
                            v.checked = false;
                        }
                ...
                if (_this2.properties.length == 0) {
                    _this2.properties = result.data.attributeResult || [];
                    ...
                    for (var i in _this2.properties) {
                        for (var j in _this2.properties[i].attributeValues) {
                            if (_this2.selectedPropIdsList.indexOf(_this2.properties[i].attributeValues[j].id.toString()) >= 0) {
        ...
        paramFormat: function paramFormat(params) {
            "use strict";
                        ...
                        if (v.length > 0 && v.indexOf(":") > 0 && (l2 = v.split(":")).length == 2) {
                            ...
                            if (l2[1].split("-").length > 0) {
                                l2[1].split("-").forEach(function (v) {
                                    l21.push(v - 0);
                                    _this3.selectedPropIdsList.push(v);
                                });
                            }
        ...
        getCategory: function getCategory(parentId) {
            ...
            _vue2.default.api.get("/api/category/list", params, function (result) {
                _this4.categoryList = result.data.categorys || [];
                if (_this4.categoryList.length > 0) {
                    _this4.getChildrenCategories(_this4.categoryList[0].categoryId);
                }
            });
        },
        getChildrenCategories: function getChildrenCategories(parentId) {
            ...
            _vue2.default.api.get("/api/category/list", params, function (result) {
                _this5.categoryChildrenList[parentId] = result.data.categorys || [];
                _this5.currentCategory = _this5.categoryChildrenList[parentId];
            });
        },

        //获取已推荐商品
        getRecommendList: function getRecommendList(isInit) {
            "use strict";
            ...
            _vue2.default.api.get("/api/seller/product/recoList", params, function (result) {
                if (isInit) _this6.recommendList = [];
                _this6.recommendList = _this6.recommendList.concat(result.data.data || []);
                _this6.totalCountR = result.data.totalCount;
            });
        },
        //推荐商品
        recommend: function recommend(mpId) {
            "use strict";
            ...
            _vue2.default.api.postForm("/api/seller/product/recommend", params, function (result) {
                $.tips({
                    content: "推荐成功",
                    stayTime: 2000,
                    type: "success"
                ...
                _this7.pageNo = 1;
                _this7.rePageNo = 1;
                _this7.getProductList(true);
                _this7.getRecommendList(true);
            });
        },
        //取消推荐商品
        cancelRecommend: function cancelRecommend(mpId) {
            "use strict";
            ...
            _vue2.default.api.postForm("/api/seller/product/cancel", params, function (result) {
                $.tips({
                    content: "取消推荐成功",
                    stayTime: 2000,
                    type: "success"
                ...
                _this8.pageNo = 1;
                _this8.rePageNo = 1;
                _this8.getProductList(true);
                _this8.getRecommendList(true);
            });
        },
        //关闭所有弹窗
        ...
        //提交搜索
        submitSearch: function submitSearch(key) {
        ...
        submitAllSelection: function submitAllSelection() {
            ...
            //跳转
            location.href = "/my/merch-manage.html?keyword=" + this.keyword + (this.prices.from.length > 0 || this.prices.to.length > 0 ? "&price=" + this.prices.from + ',' + this.prices.to : '') + (selectedPropIds.length > 0 ? "&attrValueIds=" + this.setToUrl((0, _stringify2.default)(selectedPropIds)) : '') + (selectedBrandIds.length > 0 ? "&brandIds=" + selectedBrandIds : '');
        },
    ...
    computed: {
        noRecommend: function noRecommend() {
            ...
            var boo = true;
            this.merchList.forEach(function (v) {
...
},{"../../../env/config.js":1,"../../components/ui-header.vue":2,"babel-runtime/core-js/json/stringify":5,"vue":undefined}],4:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":7}],5:[function(require,module,exports){
...
},{"./_descriptors":14,"./_export":16,"./_object-dp":23}],27:[function(require,module,exports){
(function (global){
/**
 * @license

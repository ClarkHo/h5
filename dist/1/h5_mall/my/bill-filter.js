...
var filterFlag = _vue2.default.utils.paramsFormat(window.location.href).filterFlag;
...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.filterFlag == 1) {
                _this.pageNo += 1;
                _this.filterMyBill();
            } else if (_this.filterFlag == 2) {
                _this.pageNo += 1;
                _this.filterMyIncomeBill();
            }
        });
    },
    methods: {
        // 判断是 购物 or 收益
        ifFilterFlag: function ifFilterFlag() {
        ...
        //筛选购物列表
        filterMyBill: function filterMyBill() {
            var _this2 = this;
            ...
            if (this.startTime > this.endTime) {
                ...
                _vue2.default.api.get("" + "/api/my/bill", params, function (result) {
                    // this.myBill = result.data.data;
                    _this2.myBill = _this2.myBill.concat(result.data.data);
                });
            };
        },
        //筛选收益列表
        filterMyIncomeBill: function filterMyIncomeBill() {
            var _this3 = this;
            ...
            if (this.startTime > this.endTime) {
                ...
                _vue2.default.api.get("" + "/api/seller/income/bill", params, function (result) {
                    // this.myBill = result.data.data;
                    _this3.myBill = _this3.myBill.concat(result.data.data);
                });
            };
        }

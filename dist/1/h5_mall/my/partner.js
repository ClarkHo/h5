...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getPredictSubCommissionList();
        });
    },
    methods: {

        // 子铺统计
        getSubStatistics: function getSubStatistics() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/distributor/subStatistics", params, function (result) {

                _this2.subStatistics = result.data;
            });
        },
        // 店铺列表
        getPredictSubCommissionList: function getPredictSubCommissionList() {
            ...
            _vue2.default.api.get("" + "/api/seller/distributor/list", params, function (result) {
                _this3.loaded = true;
                _this3.distributorList = _this3.distributorList.concat(result.data.data);
            });
        },
        searchPredictSubCommissionList: function searchPredictSubCommissionList() {
            var _this4 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/distributor/list", params, function (result) {
                _this4.loaded = true;
                _this4.distributorList = [];
                _this4.distributorList = result.data.data;
            });
        },
        //切换tab

...
var aid = _vue2.default.utils.paramsFormat(window.location.href).id;
...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        //TODO 实质内容判断
        checkHasTextOrImg: function checkHasTextOrImg() {
        ...
        getArticleContent: function getArticleContent() {
            ...
            _vue2.default.api.get(url, param, function (res) {
                _this.oldStr = res.data.title + res.data.content;
                _this.title = res.data.title;
                $('#editPanel').html(res.data.content);
            });
        },
        //更新文章
        updArticleContent: function updArticleContent(status) {
        ...
        //新增文章
        addOrSave: function addOrSave(status) {
            if (this.checkForm()) {
                var params = {
                    ut: _vue2.default.auth.getUserToken(),
                    companyId: _vue2.default.mallSettings.getCompanyId(),
                ...
                _vue2.default.api.postForm("" + "/api/social/live/article/create", params, function (result) {
                    //发布或者保存成功 跳转至我的
                    window.location.href = '/my/market.html?t=2';
                });
            }

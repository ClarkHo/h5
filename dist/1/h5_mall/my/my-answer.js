...
new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.totalNum > _this.askList.length) {
                _this.pageNo += 1;
                _this.getMyAskList();
            }
        });
    ...
    methods: {
        //获取当前商品的问题列表
        getMyAskList: function getMyAskList(flag) {
            var _this2 = this;
            ...
            _vue2.default.api.post(url, params, function (res) {
                if (res.data) {
                    ...
                    if (flag) {
                        _this2.askList = res.data.listObj || [];
                    } else {
                        _this2.askList = _this2.askList.concat(res.data.listObj || []);
                    }
                }
            });
        },
        swithTab: function swithTab(num) {

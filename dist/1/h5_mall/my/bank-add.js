...
new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiActionsheet: _uiActionsheet2.default, UiLocation: _uiLocation2.default },
    data: {
        //银行卡信息
        bankInfo: {
            bankId: '', //银行id
    ...
    methods: {
        ...
        getBackList: function getBackList() {
            ...
            _vue2.default.api.get("" + "/api/my/bank/bankList", params, function (result) {
                _this.bankList = result.data.bankList;
            });
        },
        // 选择地区
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet.vue":2,"../../components/ui-header.vue":3,"../../components/ui-location.vue":4,"vue":undefined}],6:[function(require,module,exports){
"use strict";

...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            _this.pageNo += 1;
            _this.getSettledSubCommissionList();
        });
    },
    methods: {

        // 已结算子店佣金列表
        getSettledSubCommissionList: function getSettledSubCommissionList() {
            var _this2 = this;

            var params = {
                ut: this.ut
            };
            _vue2.default.api.get("" + "/api/seller/income/settledSubCommissionList", params, function (result) {

                // this.settledSubCommissionList = result.data.subCommissionList;
                _this2.settledSubCommissionList = _this2.settledSubCommissionList.concat(result.data.subCommissionList);
            });
        }

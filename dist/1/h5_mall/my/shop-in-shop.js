...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        this.distributorId = _vue2.default.utils.paramsFormat(window.location.href).distributorId;
        this.level = _vue2.default.utils.paramsFormat(window.location.href).level;
        this.name = _vue2.default.utils.paramsFormat(window.location.href).name;
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.querySubList1.length < _this.totalCount) {
                _this.pageNo += 1;
                _this.getQuerySubList();
            }
        });
    },
    methods: {
        // 获取子店列表
        getQuerySubList: function getQuerySubList() {
            var _this2 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/distributor/querySubList", params, function (result) {
                _this2.totalCount = result.data.totalCount;
                // this.querySubList = result.data.data;
                _this2.querySubList1 = _this2.querySubList1.concat(result.data.data);
            });
        },
        // 查询子店
        getPredictSubCommissionList: function getPredictSubCommissionList() {
            var _this3 = this;
            ...
            _vue2.default.api.get("" + "/api/seller/distributor/querySubList", params, function (result) {
                _this3.querySubList = [];
                _this3.querySubList = result.data.data;
            });
        }
    }
});

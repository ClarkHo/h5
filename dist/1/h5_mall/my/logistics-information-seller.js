...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        loadOrderDetail: function loadOrderDetail() {
            ...
            _vue2.default.api.get("" + "/api/seller/order/detail", params, function (result) {
                ...
                if (_this.packageList.length > 0) {
                    _this.getNewOrderMessage(_this.packageList[0].packageCode);
                }
        ...
        getNewOrderMessage: function getNewOrderMessage(packageCode, index) {
            ...
            _vue2.default.api.get("" + "/api/seller/order/logistics ", params, function (result) {
                ...
                _this2.productList = _this2.productList.concat(result.data.orderInfo.productList);
            });
        }
    }
});

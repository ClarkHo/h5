...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.customer.list.length < _this.customer.totalCount) {
                _this.pageNo += 1;
    ...
    methods: {
        ...
        getCustomerList: function getCustomerList() {
            ...
            _vue2.default.api.get(url, param, function (res) {
                _this2.customer.totalCount = res.data.totalCount;
                //this.noCustomer = this.customer.totalCount == 0;
                if (res.data.data.length > 0) {
                    _this2.customer.list = _this2.customer.list.concat(res.data.data);
                }
            }, function (res) {

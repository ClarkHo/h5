...
},{"../../../core/env/config.base":8,"lodash":34}],2:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":35}],3:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("#drag-pop {\n  position: fixed;\n  /*right: 0;*/\n  /*top: 200px;*/\n  width: 60px;\n  height: 60px;\n  z-index: 10000;\n  text-align: center;\n  line-height: 80px;\n}\n#drag-pop img {\n  margin-top: 8px;\n  width: 43px;\n  height: 43px;\n}\n")
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  module.hot.dispose(function () {
    __vueify_insert__.cache["#drag-pop {\n  position: fixed;\n  /*right: 0;*/\n  /*top: 200px;*/\n  width: 60px;\n  height: 60px;\n  z-index: 10000;\n  text-align: center;\n  line-height: 80px;\n}\n#drag-pop img {\n  margin-top: 8px;\n  width: 43px;\n  height: 43px;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-c9b500e6", module.exports)
  } else {
    hotAPI.update("_v-c9b500e6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":undefined,"vue-hot-reload-api":35,"vueify/lib/insert-css":36}],4:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"babel-runtime/core-js/math/log2":10,"vue":undefined,"vue-hot-reload-api":35,"vueify/lib/insert-css":36}],5:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":35}],6:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"../../env/config.js":1,"./ui-actionsheet-pop.vue":2,"babel-runtime/core-js/json/stringify":9,"vue":undefined,"vue-hot-reload-api":35,"vueify/lib/insert-css":36}],7:[function(require,module,exports){
"use strict";
...
var _uiDrag = require("../../components/ui-drag.vue");

var _uiDrag2 = _interopRequireDefault(_uiDrag);
...
new _vue2.default({
        ...
        productList: {
            handler: function handler(val, old) {
                if (val) {
                    var price = 0,
                        num = 0;
                    this.productList.forEach(function (itemOne) {
                        try {
                            itemOne.servicrProduct.forEach(function (itemTwo) {
    ...
    methods: {
        getOrderDetail: function getOrderDetail() {
            ...
            var url = _config2.default.apiHost + "/api/my/order/detail";
            var params = {
                ut: this.ut,
            ...
            _vue2.default.api.get(url, params, function (res) {
                if (res.data) {
                    ...
                    var tempArry = [];
                    var mpIds = [];
                    res.data.childOrderList.forEach(function (itemOne) {
                        itemOne.orderProductList.forEach(function (itemTwo) {
                            tempArry.push(itemTwo);
                            mpIds.push(itemTwo.mpId);
                        });
                    });
                    // this.productList = tempArry;
                    _vue2.default.getPriceAndStock(mpIds.join(), tempArry, null, function (res) {
                        _this.productList = res;
                        _this.getService(mpIds);
                    });
                }
            });
        },
        getService: function getService(mpIds) {
            var _this2 = this;
            ...
            _vue2.default.api.postForm(url, (0, _stringify2.default)({
                ...
                if (res.data) {
                    if ($.isEmptyObject(res.data)) {
                        _vue2.default.utils.showTips('该订单没有商品可提供安装服务');
                        return;
                    }

                    for (var itemOne in res.data) {
                        _this2.productList.forEach(function (itemTwo, idx) {
                            if (itemTwo.mpId == itemOne) {
                                var mpIdArry = [];
                                res.data[itemOne].forEach(function (itemThree) {
                                    itemThree.mpId = itemThree.id;
                                    itemThree.pickNum = 0;
                                    mpIdArry.push(itemThree.id);
                                    _this2.noProFlag = false;
                                });

                                _vue2.default.getPriceAndStock(mpIdArry.join(), res.data[itemOne], null, function (result) {
                                    ...
                                    */
                                    _vue2.default.set(itemTwo, 'servicrProduct', JSON.parse((0, _stringify2.default)(result)));
                                });
                            }
                        });
                    }
        ...
        changeNum: function changeNum(item, flag, pro, s) {
            if (!item) {
                return;
            }
            ...
            if (flag) {
                if (item.stockNum > item.pickNum && item.pickNum < pro.num) {
                    ...
                    _vue2.default.set(item, "pickNum", add);
                } else {
                    _vue2.default.utils.showTips('库存不足或达到购买上限');
                }
            } else if (item.pickNum > 0 && !flag) {
                var reduce = item.pickNum - 1;
                _vue2.default.set(item, "pickNum", reduce);
            }
        },
        checkNum: function checkNum(item, server) {
            if (server.pickNum > item.num || server.pickNum > server.stockNum) {
                var flagNum = item.num < server.stockNum ? item.num : server.stockNum;
                _vue2.default.utils.showTips('最多选择' + flagNum + '个');
        ...
        goPay: function goPay() {
            ...
            var params = {
                ut: this.ut,
                platformId: _config2.default.platformId,
                skus: (0, _stringify2.default)(skus),
                businessType: 7
...
},{"../../../env/config.js":1,"../../components/ui-drag.vue":3,"../../components/ui-drop-down.vue":4,"../../components/ui-header.vue":5,"../../components/ui-order-list.vue":6,"babel-runtime/core-js/json/stringify":9,"vue":undefined}],8:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":12}],9:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":13}],10:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/math/log2"), __esModule: true };
},{"core-js/library/fn/math/log2":14}],11:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":15}],12:[function(require,module,exports){
"use strict";
...
},{"../../modules/_core":18}],14:[function(require,module,exports){
require('../../modules/es6.math.log2');
module.exports = require('../../modules/_core').Math.log2;

},{"../../modules/_core":18,"../../modules/es6.math.log2":32}],15:[function(require,module,exports){
...
},{"../../modules/_core":18,"../../modules/es6.object.define-property":33}],16:[function(require,module,exports){
...
},{"./_export":22}],33:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', { defineProperty: require('./_object-dp').f });

},{"./_descriptors":20,"./_export":22,"./_object-dp":29}],34:[function(require,module,exports){
(function (global){
/**
 * @license

...
new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (!_this.isEnd) {
                _this.pageNo += 1;
                _this.getExchangeList(true);
            }
        });
    },
    methods: {
        getExchangeList: function getExchangeList(scroll) {
            var _this2 = this;
            ...
            _vue2.default.api.get(url, params, function (res) {
                if (res.data) {
                    if (res.data.orderList && res.data.orderList.length < _this2.pageSize) {
                        _this2.isEnd = true;
                    }
                    if (scroll) {
                        _this2.exchangeList = _this2.exchangeList.concat(res.data.orderList || []);
                    } else {
                        _this2.exchangeList = res.data.orderList || [];
                    }
                }
            });
        },
        swtichTab: function swtichTab(type) {
            this.exType = type;
            this.getExchangeList();
        }
    }

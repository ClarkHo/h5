...
new _vue2.default({
    ...
    methods: {
        ...
        getExchangeRankList: function getExchangeRankList(scroll) {
            var _this = this;

            if (this.loading) return;
            var url = '/obi-web/api/product/pointProductRank.do';
            ...
            _vue2.default.api.get(url, params, function (res) {
                ...
                if (res.data) {
                    ...
                    for (var i = 0; i < res.data.datalist.length; i++) {
                        ...
                        _this.mpIds.push(res.data.datalist[i].mpId);
                    }
                    _vue2.default.getPointProPriceAndStock(_this.mpIds.join(), res.data.datalist, null, function (obj) {
                        _this.exchangeRankList = obj;
                    });
                }
            }, function () {
                _this.loading = false;

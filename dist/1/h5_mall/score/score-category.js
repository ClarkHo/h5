...
new _vue2.default({
    ...
    methods: {
        getParentCategories: function getParentCategories() {
            ...
            var params = { parentId: 0, level: 1, companyId: _vue2.default.mallSettings.getCompanyId(), pageType: 5 };
        ...
        getChildrenCategories: function getChildrenCategories(parentId) {
            ...
            _vue2.default.api.get(_config2.default.apiHost + '/api/search/searchList', params, function (result) {
                ...
                if (result.data && result.data.productList) {
                    ...
                    _vue2.default.getPointProPriceAndStock(mpIds.join(), result.data.productList, null, function (obj) {

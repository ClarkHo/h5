...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiLocation: _uiLocation2.default, UiFileUpload: _uiFileUpload2.default },
    data: {
    ...
    methods: {
        ...
        // LYF -查询增值税发票
        showVATInvoic: function showVATInvoic() {
            var _this = this;
            ...
            _vue2.default.api.post("/api/my/showVATInvoice", params, function (result) {
                _this.VATInvoice = result.data;
            });
        },
        // LYF -修改增值税发票
        editVATInvoice: function editVATInvoice() {
            var _this2 = this;
            ...
            _vue2.default.api.postForm("/api/my/editVATInvoice", params, function (result) {
                $.tips({
                    content: '修改成功',
                    stayTime: 2000,
                    type: "warn"
        ...
        ifShowArea: function ifShowArea() {
            if (this.isEdit) {
                this.showArea = true;
            }
        },
        //图片上传成功
        uploadSuccess_IncreaseTicketAuthorizePath: function uploadSuccess_IncreaseTicketAuthorizePath(data) {
            this.VATInvoice.increaseTicketAuthorizePath = data.filePath;
        },
        uploadSuccess_RegistrationCertificatePath: function uploadSuccess_RegistrationCertificatePath(data) {
            this.VATInvoice.registrationCertificatePath = data.filePath;
        },
        uploadSuccess_GeneralTaxpayerCertificatePath: function uploadSuccess_GeneralTaxpayerCertificatePath(data) {
            this.VATInvoice.generalTaxpayerCertificatePath = data.filePath;
        },
        uploadSuccess_bankLicensePath: function uploadSuccess_bankLicensePath(data) {
            this.VATInvoice.bankLicensePath = data.filePath;
        }
    }
});

},{"../../../env/config.js":1,"../../components/ui-file-upload.vue":2,"../../components/ui-header.vue":3,"../../components/ui-location.vue":4,"vue":undefined}],6:[function(require,module,exports){
"use strict";

...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiFileUpload: _uiFileUpload2.default, UiLocation: _uiLocation2.default },
    data: {
    ...
    methods: {
        // LYF -新增增值税发票
        addVATInvoice: function addVATInvoice() {
            if (!this.checkStep1()) {
                return;
            }
            // --
        ...
        VATstep1: function VATstep1() {
            if (!this.checkStep1()) {
                return;
            }
            this.navActive = 1;
        },
        VATstep2: function VATstep2() {
            if (!this.checkStep2()) {
                return;
            }
            this.navActive = 2;

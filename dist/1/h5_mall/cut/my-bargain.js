...
new _vue2.default({
    ...
    ready: function ready() {
        ...
        _vue2.default.scrollLoading(function () {
            if (_this.cutList.length < _this.total) {
                _this.pageNo += 1;
                _this.getMyCutList();
            }
        });
    ...
    methods: {
        ...
        //查询我的砍价单
        getMyCutList: function getMyCutList() {
            var _this3 = this;

            var url = _config2.default.apiHost + '/api/promotion/cut/myinst';
            var params = {
            ...
            _vue2.default.api.get(url, params, function (res) {
                if (res.data) {
                    ...
                    _this3.cutList = _this3.cutList.concat(res.data.listObj);
                }
            });
        },

...
vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        //初始化PageRestorer
        _vue2.default.pageRestorer.init(this, "cut-index");
        //restore页面的内容
        ...
        _vue2.default.scrollLoading(function () {
            ...
            if (_this.pageNo * _this.pageSize < _this.totalCount) {
                _this.pageNo += 1;
                _this.getKanjiaList();
            } else {
                _this.nomore = true;
    ...
    methods: {
        ...
        //获取砍价列表
        getKanjiaList: function getKanjiaList() {
            var _this3 = this;

            var url = _config2.default.apiHost + '/api/promotion/cut/mplist';
            var params = {
            ...
            _vue2.default.api.get(url, params, function (res) {
                if (res.data && res.data.listObj) {
                    ...
                    _this3.kanjiaList = _this3.kanjiaList.concat(res.data.listObj);
                    if (_this3.kanjiaList.length == 0) {
                        _this3.isEmpty = true;
                    }
                }
            });
        ...
        //跳转活动详情
        createInst: function createInst(kj) {

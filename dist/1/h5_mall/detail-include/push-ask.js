...
new _vue2.default({
  ...
  methods: {
    getBaseInfo: function getBaseInfo(params) {
      var _this = this;

      var url = _config2.default.apiHost + '/api/product/baseInfo';
      var params = {
        mpsIds: this.mpId,
      ...
      _vue2.default.api.get(url, params, function (res) {
        if (res.data) {
          _this.itemInfo = res.data[0];
        }
      });
    },
    pushAsk: function pushAsk(params) {
      if (this.submitting) {
        _vue2.default.utils.showTips('你点的太快啦');
        return;
      }
      if (!this.askContent) {
        _vue2.default.utils.showTips('请输入提问的内容');
        return;
      }
      ...
      _vue2.default.api.post(url, params, function (res) {
        _vue2.default.utils.showTips('发布成功');
        setTimeout(function () {
          history.back();
        }, 1000);
      });

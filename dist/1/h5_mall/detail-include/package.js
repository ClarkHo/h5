...
},{"../../../core/env/config.base":6,"lodash":93}],2:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":94}],3:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d8bfd6c2", module.exports)
  } else {
    hotAPI.update("_v-d8bfd6c2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":undefined,"vue-hot-reload-api":94}],4:[function(require,module,exports){
...
},{"../../env/config.js":1,"babel-runtime/core-js/get-iterator":7,"babel-runtime/core-js/json/stringify":8,"babel-runtime/core-js/object/assign":9,"babel-runtime/core-js/object/get-own-property-names":11,"vue":undefined,"vue-hot-reload-api":94,"vueify/lib/insert-css":95}],5:[function(require,module,exports){
"use strict";
...
var _uiNumberInput = require("../../components/ui-number-input.vue");
...
new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default, UiNumberInput: _uiNumberInput2.default, UiSerialProduct: _uiSerialProduct2.default
    },
    data: {
        currentTab: 0,
        step: 1,
        ...
        choosedPackage: {
            handler: function handler() {
                ...
                try {
                    ...
                    this.choosedPackage.promotionRuleList.forEach(function (item) {
                        item.choosedPro.forEach(function (itemTwo) {
                            _this.localObj.mpList.push(itemTwo);
                        });
                        var tempArry = [],
                            allNum = 0,
                            allAmout = 0,
                            allKind = 0;
                        item.mpList.forEach(function (res) {
                            if (res.num > 0) {
                                tempArry.push(res);
                                allNum += res.num;
                                allKind += 1;
                        ...
                        if (flag) {
                            _vue2.default.set(item, "accord", true);
                        } else {
                            _vue2.default.set(item, "accord", false);
                        }
    ...
    computed: {
        canGoPay: function canGoPay() {
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)(this.choosedPackage.promotionRuleList), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    methods: {
        ...
        stepTwoBack: function stepTwoBack() {
            this.step = 1;
        },
        //从购物车来修改套餐
        recoverPackage: function recoverPackage() {
            var _this2 = this;

            if (!this.itemId) return;
            var url = _config2.default.apiHost + '/api/cart/getCartItem';
            var params = {
                platformId: _config2.default.platformId,
                itemId: this.itemId
            };
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                _this2.recoverObj = res.data;
                _this2.getAllInfo();
            });
        },
        // 获取每个商品的促销限制
        getProLimit: function getProLimit(promIds, mpIds) {
            var _this3 = this;

            var url = _config2.default.apiHost + '/api/promotion/limitInfo';
            var params = {
            ...
            _vue2.default.api.get(url, params, function (res) {
                _this3.promotionInfo.forEach(function (itemOne, index) {
                    itemOne.promotionRuleList.forEach(function (itemTwo) {
                        var mainProFlag = false;
                        // if(itemTwo.level == 0) mainProFlag = true;
                        itemTwo.mpList.forEach(function (itemThree) {
                            res.data.forEach(function (itemFour) {
                            ...
                            //恢复套餐系列操作，先挑出用户选中的套餐
                            if (_this3.recoverObj && itemOne.promotionId == _this3.recoverObj.promotionId) {
                                ...
                                try {
                                    for (var _iterator2 = (0, _getIterator3.default)(_this3.recoverObj.mpList), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                                        var v = _step2.value;
                                            ...
                                            try {
                                                var _loop = function _loop() {
                                                    ...
                                                    if (m.product.mpId == v.mpId) {
                                                        ...
                                                        itemTwo.allAmout = (itemTwo.allAmout * 100 + itemThree.num * itemThree.availablePrice * 100) / 100;
                                                        //还原系列属性值
                                                        itemThree.attributes.forEach(function (s) {
                                                            s.values.forEach(function (ss) {
                                                ...
                                                for (var _iterator3 = (0, _getIterator3.default)(itemThree.serialProducts), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                                                    _loop();
                                                }
                                            } catch (err) {
                                                _didIteratorError3 = true;
                ...
                _this3.choosedPackage = _this3.promotionInfo[_this3.currentTab];
                _this3.choosedPackage.promotionRuleList.forEach(function (item) {
                    if (item.level == 0) {
                        _this3.mainPro = item.mpList[0];
                        if (_this3.mainPro.num == 0) {
                            _this3.mainPro.num == 1;
                        }
                    }
                });
            });
        ...
        getAllInfo: function getAllInfo(params) {
            var _this4 = this;
            ...
            if (_vue2.default.area.getArea().aC) {
                params.areaCheckFlag = 1;
                params.areaCode = _vue2.default.area.getArea().aC;
            }
            _vue2.default.api.get("/api/promotion/promotionInfo", params, function (result) {
                if (result.data.promotionInfo instanceof Array && result.data.promotionInfo.length > 0) {
                    var promIds = [],
                        mpIds = [];
                    result.data.promotionInfo[0].promotions.forEach(function (itemOne) {
                    ...
                    _this4.promotionInfo = result.data.promotionInfo[0].promotions;
                    _this4.getProLimit(promIds, mpIds);
                }
            });
        },
        setChoosedPackage: function setChoosedPackage(index) {
            var _this5 = this;

            this.choosedPackage = this.promotionInfo[index];
            this.choosedPackage.promotionRuleList.forEach(function (item) {
                if (item.level == 0) {
                    _this5.mainPro = item.mpList[0];
                    if (_this5.mainPro.num == 0) {
                        _this5.mainPro.num == 1;
                    }
                }
            });
        },
        setChoosedProArray: function setChoosedProArray(item, index) {
        ...
        changeNum: function changeNum(item, flag) {
            if ((typeof item === "undefined" ? "undefined" : (0, _typeof3.default)(item)) == "object") {
                ...
                if (flag) {
                    if (item.num >= item.individualCanBuyCount || item.num >= item.canSaleNum) {
                        ...
                        _vue2.default.utils.showTips(msg);
                        return;
                    }
                    item.num += 1;
                } else if (item.num > 0) {
                ...
                if (this.noCheckDefault) {
                    if ($(".ui-poptips-cnt").length == 0) _vue2.default.utils.showTips("请先选择商品规格！");
                    return;
                }
                if (flag) {
        ...
        comfirmChoose: function comfirmChoose() {
            var _this6 = this;
            ...
            var tempArry = [],
                ...
                allAmout = 0,
                allKind = 0;
            this.choosedProArray.forEach(function (res) {
                if (res.num > 0) {
                    tempArry.push(res);
                    allNum += res.num;
                    allKind += 1;
            ...
            if (flag) {
                _vue2.default.set(this.choosedPackage.promotionRuleList[this.choosedProArrayIndex], "accord", true);
                this.step = 1;
            } else {
                var dia = $.dialog({
                    title: '',
                ...
                dia.on("dialog:action", function (e) {
                    if (e.index == 1) {
                        ...
                        _vue2.default.set(_this6.choosedPackage.promotionRuleList[_this6.choosedProArrayIndex], "accord", false);
                        _this6.step = 1;
                    }
                });
            }
            _vue2.default.set(this.choosedPackage.promotionRuleList[this.choosedProArrayIndex], "choosedPro", tempArry);
            _vue2.default.set(this.choosedPackage.promotionRuleList[this.choosedProArrayIndex], "allAmout", allAmout);
        },
        showSerial: function showSerial(item, flag) {
            // if(item.choosedMpId){ 
        ...
        updateProduct: function updateProduct(params) {
            if (this.noCheckDefault) {
                return;
            }
            if (this.mainChooseFlag == 'main') {
                _vue2.default.set(this.mainPro, 'attres', this.itemInfoForserial.attres);
                ...
                if (this.servicePro) {
                    ...
                    try {
                        for (var _iterator4 = (0, _getIterator3.default)(this.servicePro), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                            var serItem = _step4.value;
                ...
                try {
                    for (var _iterator5 = (0, _getIterator3.default)(this.choosedPackage.promotionRuleList), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                        var v = _step5.value;
                ...
                try {
                    for (var _iterator6 = (0, _getIterator3.default)(this.choosedProArray), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                        var res = _step6.value;

                        if (res.mpId == this.choosedProMpId) {
                            _vue2.default.set(res, 'attres', this.itemInfoForserial.attres);
                            // this.mainPro.attres = this.itemInfoForserial.attres;
                            ...
                            if (this.servicePro) {
                                ...
                                try {
                                    for (var _iterator7 = (0, _getIterator3.default)(this.servicePro), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                                        var _serItem = _step7.value;

                                        if (_serItem.selected) {
                                            res.servicePro = _serItem;
                                            break;
                                        }
                                    }
                                } catch (err) {
        ...
        addToCart: function addToCart(flag) {
            ...
            this.choosedPackage.promotionRuleList.forEach(function (packageList) {
                if (packageList.level != 0) {
                    packageList.choosedPro.forEach(function (item) {
                        var obj = {
                            "mpId": item.choosedMpId,
                            "num": item.num,
                            "itemType": 1025,
                            "objectId": _this7.choosedPackage.promotionId,
                            "isMain": 0
                        };
                        if (item.servicePro) {
                            obj.additionalItems = {
            ...
            var params = {
                ...
                skus: (0, _stringify2.default)(tempSkus),
                isReplace: flag ? 1 : 0
            };
            if (_vue2.default.auth.loggedIn()) {
                params.ut = _vue2.default.auth.getUserToken();
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/cart/addItem", params, function (res) {
                ...
                if (res.code == "001001018") {
                    ...
                    dia.on("dialog:action", function (e) {
                        if (e.index == 0) {
                            _this7.addToCart(true);
                        }
                    });
                } else {
                    _vue2.default.utils.showTips(res.message);
                    _this7.recoverObj = _this7.localObj;
                    _this7.getAllInfo();
                }
            });
        },
        //修改套餐
        editGroup: function editGroup(params) {
            var _this8 = this;
                ...
                if (packageList.level != 0) {
                    packageList.choosedPro.forEach(function (item) {
                        var obj = {
                            ...
                            "num": item.num,
                            "itemType": 1025,
                            "objectId": _this8.choosedPackage.promotionId,
                            "isMain": 0
                        };
                        if (item.servicePro) {
                            obj.additionalItems = {
            ...
            var url = _config2.default.apiHost + '/api/cart/editGroup';
            _vue2.default.api.postForm(url, params, function (res) {
                _vue2.default.utils.showTips('修改成功');
            });
        },
        pay: function pay() {
            var _this9 = this;
                ...
                if (packageList.level != 0) {
                    packageList.choosedPro.forEach(function (item) {
                        var obj = {
                            ...
                            "num": item.num,
                            "itemType": 1025,
                            "objectId": _this9.choosedPackage.promotionId,
                            "isMain": 0
                        };
                        if (item.servicePro) {
                            obj.additionalItems = {
            ...
            _vue2.default.utils.quickPurchase(params, function (res) {
                // window.location.href = "/pay/pay.html?q=1";
                _vue2.default.utils.showTips(res.message);
                _this9.recoverObj = _this9.localObj;
                _this9.getAllInfo();
            }, false);
        }
...
},{"../../../env/config.js":1,"../../components/ui-header.vue":2,"../../components/ui-number-input.vue":3,"../../components/ui-serial-product.vue":4,"babel-runtime/core-js/get-iterator":7,"babel-runtime/core-js/json/stringify":8,"babel-runtime/helpers/typeof":15,"vue":undefined}],6:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":14}],7:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/get-iterator"), __esModule: true };
},{"core-js/library/fn/get-iterator":16}],8:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":17}],9:[function(require,module,exports){
...
},{"core-js/library/fn/object/get-own-property-names":20}],12:[function(require,module,exports){
...
},{"../modules/core.get-iterator":82,"../modules/es6.string.iterator":88,"../modules/web.dom.iterable":92}],17:[function(require,module,exports){
...
},{"../../modules/_core":29,"../../modules/es6.object.assign":84}],19:[function(require,module,exports){
...
},{"../../modules/_core":29,"../../modules/es6.object.define-property":85}],20:[function(require,module,exports){
...
},{"../../modules/_core":29,"../../modules/es6.object.get-own-property-names":86}],21:[function(require,module,exports){
...
},{"../../modules/_core":29,"../../modules/es6.object.to-string":87,"../../modules/es6.symbol":89,"../../modules/es7.symbol.async-iterator":90,"../../modules/es7.symbol.observable":91}],22:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
...
},{"./_hide":40,"./_object-create":53,"./_property-desc":65,"./_set-to-string-tag":67,"./_wks":80}],47:[function(require,module,exports){
'use strict';
...
},{"./_export":36,"./_hide":40,"./_iter-create":46,"./_iterators":49,"./_library":50,"./_object-gpo":60,"./_redefine":66,"./_set-to-string-tag":67,"./_wks":80}],48:[function(require,module,exports){
...
},{"./_an-object":25,"./_dom-create":33,"./_enum-bug-keys":34,"./_html":41,"./_object-dps":55,"./_shared-key":68}],54:[function(require,module,exports){
var anObject = require('./_an-object');
...
},{"./_an-object":25,"./_descriptors":32,"./_ie8-dom-define":42,"./_to-primitive":76}],55:[function(require,module,exports){
var dP = require('./_object-dp');
var anObject = require('./_an-object');
var getKeys = require('./_object-keys');
...
},{"./_descriptors":32,"./_has":39,"./_ie8-dom-define":42,"./_object-pie":63,"./_property-desc":65,"./_to-iobject":73,"./_to-primitive":76}],57:[function(require,module,exports){
...
},{"./_array-includes":26,"./_has":39,"./_shared-key":68,"./_to-iobject":73}],62:[function(require,module,exports){
...
},{"./_export":36,"./_object-assign":52}],85:[function(require,module,exports){
var $export = require('./_export');
...
},{"./_object-gopn-ext":57,"./_object-sap":64}],87:[function(require,module,exports){
...
},{"./_an-object":25,"./_descriptors":32,"./_enum-keys":35,"./_export":36,"./_fails":37,"./_global":38,"./_has":39,"./_hide":40,"./_is-array":44,"./_is-object":45,"./_library":50,"./_meta":51,"./_object-create":53,"./_object-dp":54,"./_object-gopd":56,"./_object-gopn":58,"./_object-gopn-ext":57,"./_object-gops":59,"./_object-keys":62,"./_object-pie":63,"./_property-desc":65,"./_redefine":66,"./_set-to-string-tag":67,"./_shared":69,"./_to-iobject":73,"./_to-primitive":76,"./_uid":77,"./_wks":80,"./_wks-define":78,"./_wks-ext":79}],90:[function(require,module,exports){
...
},{"./_global":38,"./_hide":40,"./_iterators":49,"./_wks":80,"./es6.array.iterator":83}],93:[function(require,module,exports){
(function (global){
/**
 * @license

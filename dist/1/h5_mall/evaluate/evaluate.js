...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        getEvaluateList: function getEvaluateList() {
            ...
            _vue2.default.api.get("/api/social/read/comment/myCommentList", params, function (result) {
                var data = result.data || {};
                var commentList = data.commentList || [];

                if (commentList.length > 0) {
                    _this3.commentList = _this3.commentList.concat(data.commentList);
                }

                if (commentList.length < _this3.pageSize) {
                    _this3.isEnd = true;
                }
            });
        },

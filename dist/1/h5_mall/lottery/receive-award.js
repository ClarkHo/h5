...
new _vue2.default({
    ...
    methods: {
        //获取抽奖信息
        getReceiveDetail: function getReceiveDetail() {
            var _this = this;
            ...
            _vue2.default.api.get("/api/promotion/lottery/init", params, function (result) {
                if (result.data) {
                    _this.receiveDetail = result.data;
                    _this.isLoaded = true;
                }
            });
        },
        ...
        confirm: function confirm() {
            ...
            if (!rid) {
                _vue2.default.utils.showTips("请选择收货地址");
                return;
            }

            var params = { ut: this.ut, recordId: recordId, receiver: { receiverId: rid } };
            _vue2.default.api.post("/api/promotion/lottery/save", params, function (result) {

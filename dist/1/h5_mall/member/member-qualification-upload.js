...
var vm = new _vue2.default({
    ...
    methods: {
        ...
        checkHasvolunteer: function checkHasvolunteer() {
            ...
            _vue2.default.api.postForm("/ouser-center/api/user/info/detail.do", params, function (result) {
                if (result.code == 0) {
                    var msg = result.data;
                    _this.sectionShow = msg.userInfo.licenseAuditStatus;
                } else {}
            });
        },

        //
        addPipeInvoice: function addPipeInvoice() {
            var _this2 = this;
            ...
            _vue2.default.api.postForm("/ouser-center/api/user/member/applyMemberIdentity.do", params, function (result) {
                if (result.code == 0) {
                    //界面变为审核中
                    _this2.sectionShow = 0;
                } else {
                    $.tips({
        ...
        uploadSuccess_BusinessLicensePath: function uploadSuccess_BusinessLicensePath(data) {

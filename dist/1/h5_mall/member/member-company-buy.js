...
new _vue2.default({
    ...
    data: {
        ...
        urlParams: _vue2.default.utils.paramsFormat(window.location.href),
    ...
    methods: {
        getMemberInfo: function getMemberInfo() {
            ...
            _vue2.default.api.postForm("/ouser-center/api/user/info/detail.do", params, function (result) {
                ...
                if (data && data.memberInfo) {
                    ...
                    _vue2.default.utils.showTips(result.message || '请稍后重试');
                }
            });
        },
        saveMemberInfo: function saveMemberInfo() {
            var self = this;
            var params = {
                identityTypeCode: 42,
        ...
        changeMemberInfo: function changeMemberInfo() {
            ...
            if (!self.newEnterpriseSecret) {
                ...
                _vue2.default.utils.showTips('不能重复绑定优购码');
                return;
            }
            _vue2.default.api.postForm("/ouser-center/api/user/member/applyMemberIdentity.do", params, function (result) {
                _vue2.default.utils.showTips('操作成功');

...
},{"vue":undefined,"vue-hot-reload-api":27,"vueify/lib/insert-css":28}],3:[function(require,module,exports){
"use strict";
...
new _vue2.default({
    el: 'body',
    components: {
        UiHeader: _uiHeader2.default, UiBtnCopy: _uiBtnCopy2.default
    },
    data: {
        employeeCode: "",
        identityCardNo: "",
    ...
    methods: {
        ...
        copy: function copy() {
            ...
            _vue2.default.api.get(url, params, function (res) {
                _this2.shareLink = res.data.linkUrl + "&shareName=" + _this2.username;
            });
        },
        //获取已经邀请和剩余的人数
        already: function already() {
            ...
            _vue2.default.api.post(url, params, function (res) {
                if (res.code == 0) {
                    _this3.inviteUserLimit = res.inviteUserLimit;
                    _this3.invitedUserCount = res.invitedUserCount;
                    _this3.surplus = _this3.inviteUserLimit - _this3.invitedUserCount;
                }
            });
        },
        register: function register() {
            ...
            if (!this.realName) {
                _vue2.default.utils.showTips('请输入真实姓名');
                return;
            }

            if (!this.employeeCode) {
                _vue2.default.utils.showTips('请输入员工号');
                return;
            }

            if (!this.identityCardNo || !this.identityCardNo.match(/(^\d{3}(\d|X|x)$)/)) {
                _vue2.default.utils.showTips('请输入身份证后四位');
                return;
            }

            var url = "/ouser-center/api/user/member/applyMemberIdentity.do";
            _vue2.default.api.postForm(url, param, function (res) {
                _vue2.default.utils.showTips('申请成功');
                _this4.already();
                _this4.checkHasvolunteer();
                _this4.step = 2;
            }, function (res) {
                if (res.code == 6) {
                    _vue2.default.utils.showTips('请校验输入参数');
                } else {
        ...
        //对用户状态进行验证
        checkHasvolunteer: function checkHasvolunteer() {
            var _this5 = this;

            var params = {
                identityTypeCode: 4
            };
            _vue2.default.api.postForm("/ouser-center/api/user/info/detail.do", params, function (res) {
                _this5.userInfo = res.data;
                if (res.code == 0) {
                    if (res.data.memberInfo.memberTypeName == "内购会员") {
                        _this5.step = 2;
                        _this5.username = res.data.memberInfo.realName;
                        _this5.inviteUserMobile = res.data.userInfo.inviteUserMobile;
                        //被邀请人
                        if (res.data.userInfo.identityTypeCode == 4) {
                            _this5.childStep = 2;
                        } else if (res.data.userInfo.identityTypeCode == 41) {
                            //邀请人
                            _this5.childStep = 1;
                        }
                        _this5.copy();
                    ...
                    if (res.data.memberInfo.memberTypeName == "普通会员") {
                        ...
                        _vue2.default.utils.showTips('您还不是普通会员');
                        _this5.step = 3;
                        return;
                    }
                }
...
},{"../../../env/config.js":1,"../../components/ui-btn-copy.vue":2,"../../components/ui-header.vue":3,"vue":undefined}],5:[function(require,module,exports){
"use strict";

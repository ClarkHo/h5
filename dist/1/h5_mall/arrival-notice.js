...
new _vue2.default({
    ...
    methods: {
        // 初始化商品信息和用户手机号
        initAttentionMerchat: function initAttentionMerchat() {
            var _this = this;
            ...
            _vue2.default.api.get("/api/attention/initAttentionMerchantProduct", params, function (res) {
                _this.initData = res.data;
                _this.mobile = res.data.mobile;
            });
        },
        // 到货通知
        getAttentionMerchant: function getAttentionMerchant() {
            if (!this.mobile) {
                $.tips({
                    content: '请输入手机号',
                    stayTime: 2000,
            ...
            _vue2.default.api.postForm("/api/attention/attentionMerchantProduct", params, function (res) {

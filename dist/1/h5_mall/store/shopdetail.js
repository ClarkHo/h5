...
},{"vue":undefined,"vue-hot-reload-api":28,"vueify/lib/insert-css":29}],5:[function(require,module,exports){
"use strict";
...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiActionsheetPop: _uiActionsheetPop2.default, UiImageViewer: _uiImageViewer2.default },
    data: {
    ...
    methods: {
        ...
        getShopInfo: function getShopInfo() {
            ...
            _vue2.default.api.get(url, params, function (result) {
                if (result.data) {
                    _this2.shopInfo = result.data;
                    _this2.itemImages = result.certificateFiles || [];
                }
            });
        },
        //是否收藏
        getfavorite: function getfavorite(params) {
            ...
            _vue2.default.api.postForm(url, params, function (res) {
                _this3.hasFavorite = res.isFavorite;
            });
        },
        //收藏
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet-pop.vue":2,"../../components/ui-header.vue":3,"../../components/ui-image-viewer.vue":4,"vue":undefined}],6:[function(require,module,exports){
"use strict";

...
},{"../../../core/env/config.base":5,"lodash":28}],2:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":29}],3:[function(require,module,exports){
"use strict";
...
},{"vue":undefined,"vue-hot-reload-api":29}],4:[function(require,module,exports){
"use strict";
...
var vm = new _vue2.default({
    ...
    components: {
        ...
        UiActionsheetPop: _uiActionsheetPop2.default
    },
    data: {
    ...
    ready: function ready() {
        ...
        //滚动加载更多数据
        _vue2.default.scrollLoading({
            parentEl: '#product-wrappers',
            childEl: '#product-wrapper',
            callback: function callback() {
                switch (_this.current) {
                    case 'all':
                        if (!_this.showSequencePop && _this.totalCount > _this.allProductList.length) {
                            _this.pageNo += 1;
                            _this.getSearchList(_this.sortType);
                        }
                        break;
                    case 'new':
                        if (_this.newProductTotal > _this.newProductList.length) {
                            _this.pageNo_n += 1;
                            _this.getNewProductList();
                        }
                        break;
                    case 'activity':
                        if (_this.promotionTotal > _this.promotionList.length) {
                            _this.pageNo_p += 1;
                            _this.getPromotion();
                        }
                        break;
    ...
    methods: {
        getfavorite: function getfavorite(params) {
            var _this2 = this;
        ...
        switchTab: function switchTab(str) {
            if (!str) return;
        ...
        //上新商品
        getNewProductList: function getNewProductList(flag) {
            var _this5 = this;
            ...
            _vue2.default.api.get("/api/search/searchList", params, function (result) {
                if (result.data) {
                    if (result.data.productList) {
                        if (flag) {
                            _this5.newProductList = result.data.productList;
                        } else {
                            _this5.newProductList = _this5.newProductList.concat(result.data.productList);
                        }
                    }
                    _this5.newProductTotal = result.data.totalCount;
                }
            }, function () {
                //处理掉不显示报错
            });
        ...
        getSearchList: function getSearchList() {
            ...
            if (this.attrs != null) {
                params.shoppingGuideJson = (0, _stringify2.default)({
            ...
            _vue2.default.api.get("/api/search/searchList", params, function (result) {
                if (result.data) {
                    if (result.data.productList) {
                        if (flag) {
                            _this6.allProductList = result.data.productList;
                        } else {
                            _this6.allProductList = _this6.allProductList.concat(result.data.productList);
                        }
                    }
                    _this6.properties = result.data.attributeResult || [];
                    _this6.propertiesBak = (0, _stringify2.default)(_this6.properties);
                    _this6.sortByList = result.data.sortByList;
                    _this6.allProductTotal = result.data.totalCount;
                    _this6.totalCount = result.data.totalCount;
                }
            }, function () {
                //处理掉不显示报错
            });
        ...
        //店铺活动信息
        getPromotion: function getPromotion(flag) {
            var _this7 = this;
            ...
            _vue2.default.api.get("/api/promotion/merchantPromotionList", params, function (result) {
                if (result.data) {
                    if (flag) {
                        _this7.promotionList = result.data.listObj;
                    } else {
                        _this7.promotionList = _this7.promotionList.concat(result.data.listObj);
                    }
                    _this7.promotionTotal = result.data.total;
                }
            }, function () {
                //处理掉不显示报错
            });
        ...
        //去对应的店铺活动
        goPromotion: function goPromotion(pid) {
            if (!pid) {
                return;
            }
            var url = "/store/search.html?promotionId=" + pid;
            return url;
        },
        //店铺基本信息
        getShopInfo: function getShopInfo() {
            ...
            var url = "/back-merchant-web/shop/baseInfo.do";
            var params = {
                merchantId: this.merchantId
            };
            _vue2.default.api.get(url, params, function (result) {
                _this8.shopInfo = result.data;
            });
        },
        ...
        //加入购物车
        addItemInCart: function addItemInCart(mpid) {
            var _this9 = this;
        ...
        submitAllSelection: function submitAllSelection() {
            ...
            if (this.prices.from > this.prices.to) {
                var _ref = [this.prices.to, this.price.from];
                this.price.from = _ref[0];
                this.prices.to = _ref[1];
            }
            //跳转
            ...
            this.attrs = this.setToUrl((0, _stringify2.default)(selectedPropIds));
        ...
        isFavorite: function isFavorite() {
            ...
            _vue2.default.api.post(url, param, function (result) {});
        },
        //收藏
        addFavorite: function addFavorite() {
            var _this10 = this;

            _vue2.default.utils.goLogin();
            var param = {
                ut: _vue2.default.auth.getUserToken(),
                type: '3',
                entityId: this.merchantId
            };
            var url = _config2.default.apiHost + "/ouser-center/api/favorite/add.do";
            _vue2.default.api.postForm(url, param, function (result) {
                _vue2.default.utils.showTips('收藏成功');
                _this10.getfavorite();
                _this10.getShopInfo();
            });
        },
        //取消
        delFavorite: function delFavorite() {
            var _this11 = this;
            ...
            var url = _config2.default.apiHost + "/ouser-center/api/favorite/delete.do";
            _vue2.default.api.postForm(url, param, function (result) {
                _vue2.default.utils.showTips('取消收藏成功');
                _this11.getfavorite();
                _this11.getShopInfo();
            });
        },
    ...
    filters: {
        countFliter: function countFliter(num) {
            if (num > 9999) {
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet-pop.vue":2,"../../components/ui-header.vue":3,"babel-runtime/core-js/json/stringify":6,"vue":undefined,"vue-lazyload":undefined}],5:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/json/stringify":9}],7:[function(require,module,exports){

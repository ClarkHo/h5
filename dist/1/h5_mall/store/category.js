...
new _vue2.default({
    ...
    methods: {
        ...
        // 获取店铺分类类目树id
        getShopcateTree: function getShopcateTree() {
            var _this = this;
            ...
            _vue2.default.api.postForm("/back-product-web/merchantProductAppAction/getMerchantAPPCateTree.do", params, function (result) {
                _this.getMerchantTree(result);
            }, function () {});
        },
        //获取店铺分类一级、二级、三级分类类目树
        getMerchantTree: function getMerchantTree(item) {
            var _this2 = this;

            if (!item.data.id) {
                _vue2.default.utils.showTips('类目树id错误');
                return;
            }
            var params = {
                // merchantId: this.merchantId,
            ...
            _vue2.default.api.postForm('/back-product-web/merchantProductAppAction/getCategoryTreeApp.do', params, function (result) {
                if (result.data) {
                    _this2.parentCategories = result.data.childList;
                    if (_this2.parentCategories.length) _this2.childrenCategories = _this2.parentCategories[0].childList;
        ...
        getChildrenCategories: function getChildrenCategories(parentId) {
            ...
            this.parentCategories.forEach(function (item) {
                // console.log(item)
                if (item.categoryId == parentId) {
                    _this3.childrenCategories = item.childList;
                    return;
                }
            });
        },
...
},{"../../../env/config.js":1,"../../components/ui-header.vue":2,"vue":undefined,"vue-lazyload":undefined}],4:[function(require,module,exports){
"use strict";

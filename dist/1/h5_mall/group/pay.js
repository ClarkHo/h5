...
new _vue2.default({
    ...
    methods: {
        getOrderDetails: function getOrderDetails() {
            ...
            _vue2.default.api.post(_config2.default.apiHost + "/api/checkout/showGroupBuyOrder", params, function (result) {
        ...
        savePayment: function savePayment(paymentId) {
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/checkout/savePayment", params, function (result) {
                //do nothing
            });
        },
        ...
        submitOrder: function submitOrder() {
            ...
            _vue2.default.api.postForm(_config2.default.apiHost + "/api/checkout/submitGroupBuyOrder", params, function (result) {
                if (_vue2.default.browser.weixin()) {
                    location.href = _vue2.default.utils.getPayUrl(result.data.orderCode + '_' + result.data.groupOrderCode, '&paystate=1');
                } else if (_vue2.default.browser.isApp()) {
                    var url = 'yh://pay?body={"orderCode":"' + result.data.orderCode + '","amount":' + result.data.amount + ', "url": "' + _vue2.default.utils.getPayBackUrl(result.data.orderCode + '_' + result.data.groupOrderCode) + '"}';
                    location.href = url;
                } else {
        ...
        getAddressUrl: function getAddressUrl() {
            ...
            base += base.indexOf('?') > 0 ? '&from=' + encodeURIComponent(_vue2.default.utils.getRelatedUrl()) : '?from=' + encodeURIComponent(_vue2.default.utils.getRelatedUrl());

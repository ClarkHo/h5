...
},{"vue":undefined,"vue-hot-reload-api":28}],5:[function(require,module,exports){
"use strict";
...
var pushStatus = _vue2.default.localStorage.getItem("pushStatus");
var urlParams = _vue2.default.utils.paramsFormat(decodeURIComponent(location.href));

var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiFileUpload: _uiFileUpload2.default, UiActionsheet: _uiActionsheet2.default },
    data: {
        showTalk: false,
        hasPassword: true,
    ...
    ready: function ready() {
        ...
        if (this.isApp) {
            _vue2.default.app.postMessage("getCache", function (data) {
                _this.cache = data;
            });
        }
        // this.checkPassword();
    ...
    computed: {
        pageConfig: function pageConfig() {
            return _config2.default.setting || {};
        }
    },
    methods: {
        ...
        logout: function logout() {
            ...
            //调取退出登录接口
            _vue2.default.api.post(url, param, function () {

                if (_this2.isApp) {
                    _vue2.default.app.logout();
                } else {
        ...
        uploadSuccess: function uploadSuccess(data) {
            ...
            _vue2.default.distribution.clearCurrentDistributionData();
            if (this.isApp) {
                //通知app刷新个人中心页面
        ...
        getUserInfo: function getUserInfo() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                _this4.headPicUrl = res.data.url100x100;
            });
        },
        //更新用户信息
        ...
        clearCache: function clearCache() {
            ...
            _vue2.default.app.postMessage("clearCache", function () {
                _this6.cache = '0MB';
            });
        },
        //消息推送
        messagePushed: function messagePushed() {
            this.status = !this.status;
            _vue2.default.localStorage.setItem("pushStatus", this.status);
            _vue2.default.app.postMessage("pushCtrl", { status: this.status });
        },
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet.vue":2,"../../components/ui-file-upload.vue":3,"../../components/ui-header.vue":4,"vue":undefined}],6:[function(require,module,exports){
"use strict";

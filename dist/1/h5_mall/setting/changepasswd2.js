...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        //解决浏览器记住密码的功能
        setTimeout(function () {
            _this.spypassword = 'password';
            _this.spypassword1 = 'password';
            _this.spypassword2 = 'password';
        }, 200);
    },
    methods: {
        modifyPassword: function modifyPassword() {
            ...
            var url = _config2.default.ouserHost + '/ouser-web/user/resetUserPassword.do';
            var param = {
            ...
            _vue2.default.api.post(url, param, function (res) {
                ...
                setTimeout(function () {
                    window.location.href = _config2.default.contextPath + "/setting/account-security.html";
                }, 2000);
            });
        }
    }

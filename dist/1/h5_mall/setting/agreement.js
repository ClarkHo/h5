...
var vm = new _vue2.default({
    ...
    methods: {
        getUserRegisterProtocol: function getUserRegisterProtocol() {
            var _this = this;
            ...
            _vue2.default.api.get(url, param, function (res) {
                if (res.data.reg_protocol && res.data.reg_protocol[0]) {
                    _this.protocolTitle = res.data.reg_protocol[0].title;
                    _this.registerProtocol = res.data.reg_protocol[0].content;
                }
            });
        }
    }

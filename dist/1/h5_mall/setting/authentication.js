...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":28}],4:[function(require,module,exports){
"use strict";
...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiDialogCaptchas: _uiDialogCaptchas2.default, UiActionsheet: _uiActionsheet2.default },
    data: {
        title: '身份验证',
        step: 0, //步骤
    ...
    methods: {
        ...
        //获取绑定手机
        getBoundMobile: function getBoundMobile() {
            var _this = this;

            var url = _config2.default.apiHost + '/api/my/user/getBoundMobile?ut=' + _vue2.default.auth.getUserToken() + '&' + new Date().getTime();
            _vue2.default.api.get(url, null, function (res) {
                _this.user.oldmobile = res.data.mobile;
                //this.user.showMobile = tel.substring(0,3) + "****" + tel.substring(7,11);
            });
        },
        //显示图片验证码
        oldShowImgViCode: function oldShowImgViCode() {
        ...
        //下一步，验证验证码
        valiCaptchas: function valiCaptchas() {
            var _this2 = this;
            ...
            var url = _config2.default.ouserHost + '/ouser-web/mobileRegister/checkCaptchasForm.do';
            var param = {
        ...
        bindMobile: function bindMobile() {
            ...
            var url = _config2.default.ouserHost + '/ouser-web/mobileRegister/checkMobileAndModifyMobileForm.do';
            var param = {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                ...
                _this4.getBoundMobile();
                _this4.user.oldmobile = '';
                _this4.user.oldcaptchas = '';
                _this4.user.mobile = '';
                _this4.user.captchas = '';
                _this4.step = 0;
            });
        }
    }
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet.vue":2,"../../components/ui-dialog-captchas.vue":3,"../../components/ui-header.vue":4,"vue":undefined}],6:[function(require,module,exports){
"use strict";

...
var vm = new _vue2.default({
    ...
    ready: function ready() {
        ...
        if (_vue2.default.localStorage.getItem('username')) {
            this.user.mobile = _vue2.default.localStorage.getItem('username');
            this.readOnly = true;
        }
    },
    methods: {
        ...
        overLimitSmsSend: function overLimitSmsSend() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                ...
                _this2.smsBtnDisabled = true;
                _this2.smsBtn = _this2.waitingTime + 's';
                var inter = setInterval(function () {
                    _this2.waitingTime--;
                    _this2.smsBtn = _this2.waitingTime + 's';
                    if (_this2.waitingTime === 0) {
                        _this2.smsBtn = '重新获取';
                        _this2.smsBtnDisabled = false;
                        _this2.waitingTime = 60;
                        clearInterval(inter);
                    }
                }, 1000);
        ...
        getImg: function getImg() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                _this3.image = res.image;
                _this3.imageKey = res.imageKey;
            });
        },
        //刷新验证码
        ...
        checkViCode: function checkViCode() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                ...
                //验证手机号是否已注册
                if (res.code == -1) _this4.smsSend(); //显示
            });
        },
        //发送验证码
        ...
        modifyPassword: function modifyPassword() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                ...
                setTimeout(function () {
                    window.location.href = _config2.default.contextPath + "/my/home.html";
                }, 2000);
            }, function (res) {

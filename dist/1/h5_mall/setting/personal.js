...
exports.default = {
    ...
    methods: {
        ...
        //确认
        updUserInfo: function updUserInfo() {
            if (this.type == 'nickname' && this.userInfo.nickname == '') {
                this.showTipsPop('请输入昵称');
                return false;
            }
            ...
            var url = _config2.default.apiHost + '/api/my/user/updateInfo';
            var param = {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                ...
                if (_vue2.default.browser.isApp()) {
                    //通知app刷新个人中心页面
                    _vue2.default.app.postMessage("pageRefresh");
                }
                // console.log(this.userInfo.userAddress);
                _vue2.default.utils.showTips("资料修改成功");
            });
            this.show = false;
        }
    }
...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":32}],7:[function(require,module,exports){
"use strict";
...
var _uiLocation = require("../../components/ui-location.vue");
...
var _uiEdit = require("../../components/ui-edit.vue");

var _uiEdit2 = _interopRequireDefault(_uiEdit);
...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiActionsheet: _uiActionsheet2.default, UiLocation: _uiLocation2.default, UiFileUpload: _uiFileUpload2.default, UiEdit: _uiEdit2.default },
    data: {
        ...
        showEdit: false,
        type: '',
        headPicUrl: '/images/no-header.png?v=1538189604568', //头像
        userInfo: {}, //用户信息
    ...
    methods: {
        ...
        getUserInfo: function getUserInfo() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                ...
                _this.headPicUrl = res.data.url100x100;
                _this.userInfoOld = (0, _stringify2.default)(res.data);
                $('#picktime').val(res.data.birthdayStr);
            });
        },
        //更新用户头像
        updUserPic: function updUserPic() {
            var _this2 = this;
        ...
        chooseArea: function chooseArea(po) {
            var _this3 = this;
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                _this3.getUserInfo();
                _vue2.default.utils.showTips("保存成功");
            });
        },
        //更新用户信息
        updUserInfo: function updUserInfo() {
            ...
            //比较用户信息是否修改
            var uiStr = (0, _stringify2.default)(this.userInfo);
            if (uiStr === this.userInfoOld) {
                //未修改
                this.isEditStatus = 0;
        ...
        // 判断此系统是否需要实名认证
        ifNeedIdentity: function ifNeedIdentity() {
            var _this6 = this;

            var url = _config2.default.apiHost + '/api/commondata/getConfig';
            var param = {};
            _vue2.default.api.get(url, param, function (res) {
                if (res.data.realNameRequired == 1) {
                    _this6.isNeedIdentity = true;
                    _this6.ifIdentity();
                } else {
                    _this6.isNeedIdentity = false;
                }
            }, function () {});
        },
        // 是否已实名认证
        ifIdentity: function ifIdentity() {
            var _this7 = this;

            var url = _config2.default.apiHost + '/ouser-center/realNameAuth/getRealNameAuthInfo.do';
            var param = {
                ut: _vue2.default.auth.getUserToken()
            };
            _vue2.default.api.postForm(url, param, function (res) {
                _this7.identityStatus = res.data.authStatus; // -1未提交认证，3认证失败  0已提交待审核，1待认证，2认证成功
                if (_this7.identityStatus == 0) {
                    // 已提交待审核
                    _this7.isIdentityTipsWords = "已提交待审核";
                } else if (_this7.identityStatus == 2) {
                    // 认证成功
                    _this7.isIdentityTipsWords = "已认证";
                } else if (_this7.identityStatus == 3) {
                    // 认证失败
                    _this7.isIdentityTipsWords = "认证失败";
                } else if (_this7.identityStatus == 1) {
                    // 1待认证
                    _this7.isIdentityTipsWords = "待认证";
                } else {
                    // 未提交认证
                    _this7.isIdentityTipsWords = "立即认证";
                }
                _this7.idInfo = res.data;
            }, function () {
                // 异常返回
                _this7.identityStatus = 7;
            });
        },
        // 点击实名认证跳转
        identityGoto: function identityGoto() {
...
},{"../../../env/config.js":1,"../../components/ui-actionsheet.vue":2,"../../components/ui-edit.vue":3,"../../components/ui-file-upload.vue":4,"../../components/ui-header.vue":5,"../../components/ui-location.vue":6,"babel-runtime/core-js/json/stringify":9,"vue":undefined}],8:[function(require,module,exports){
"use strict";

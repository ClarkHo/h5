...
},{"../../../core/env/config.base":3,"lodash":24}],2:[function(require,module,exports){
"use strict";
    ...
    methods: {
        ...
        getDistributorId: function getDistributorId() {
            if (urlParams.distributorId) {
                //存储分销商ID
                _vue2.default.auth.setDistributorId(1, urlParams.distributorId);
            }
        ...
        jumpToPage: function jumpToPage() {
            ...
            switch (urlParams.type) {
                ...
                case "8":
                    if (urlParams.shareCode) {
                        _vue2.default.cookie.setCookie('shareCode8', urlParams.shareCode);
                    }
            ...
            if (!_vue2.default.browser.isApp()) {
                setTimeout(function () {
                    //3秒后打开H5页面
                    window.location.href = _this.jumpPage;
                }, 3000);
            } else {
...
},{"../../env/config.js":1,"vue":undefined}],3:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":5}],4:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":6}],5:[function(require,module,exports){
"use strict";

...
},{"../../env/config.js":1,"vue":undefined,"vue-hot-reload-api":27}],3:[function(require,module,exports){
"use strict";
...
var vm = new _vue2.default({
    el: 'body',
    components: { UiHeader: _uiHeader2.default, UiDialogCaptchas: _uiDialogCaptchas2.default },
    data: {
        user: {
            mobile: '',
            captchas: ''
    ...
    methods: {
        ...
        overLimitSmsSend: function overLimitSmsSend() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                //验证码发送成功
                _this.startImgCode = false; //隐藏图片验证码窗口
                _this.smsBtnDisabled = true;
                _this.smsBtn = _this.waitingTime + 's';
                var inter = setInterval(function () {
                    _this.waitingTime--;
                    _this.smsBtn = _this.waitingTime + 's';
        ...
        getImg: function getImg() {
            ...
            var url = _config2.default.apiHost + '/ouser-web/mobileRegister/checkImageForm.do';
            var param = {
                width: 160,
                height: 60
            };
        ...
        checkViCode: function checkViCode() {
            ...
            var inter = setInterval(function () {
                _this3.waitingTime--;
                _this3.smsBtn = _this3.waitingTime + 's';
                if (_this3.waitingTime === 0) {
                    _this3.smsBtn = '重新获取';
                    _this3.smsBtnDisabled = false;
                    _this3.waitingTime = 60;
                    clearInterval(inter);
                }
            }, 1000);
        ...
        //绑定手机号
        ckBindMobile: function ckBindMobile() {
            if (!this.user.mobile || !/^[0-9]{11}$/.test(this.user.mobile)) {
                $.tips({
                    content: '请输入正确的手机号',
                    stayTime: 2000,
        ...
        //获取绑定手机号
        getBindMobile: function getBindMobile() {
            var _this4 = this;
        ...
        bindMobile: function bindMobile() {
            ...
            _vue2.default.api.postForm(url, param, function (res) {
                if (res.code == 0) {
                    _vue2.default.utils.showTips("绑定成功");
                    if (_vue2.default.cookie.getCookie("unite_login")) {
                        var returnUrl = _vue2.default.cookie.getCookie("unite_login");
        ...
        unionLogin: function unionLogin() {
            var param = _vue2.default.utils.paramsFormat(window.location.href);
            if (param.needBind == "true") {
                _vue2.default.auth.setUserToken(param.ut);
...
},{"../../env/config.js":1,"../components/ui-dialog-captchas.vue":2,"../components/ui-header.vue":3,"vue":undefined}],5:[function(require,module,exports){
"use strict";

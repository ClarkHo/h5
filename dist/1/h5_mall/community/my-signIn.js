...
new _vue2.default({
    ...
    methods: {
        ...
        surprise: function surprise(day) {
            var tips = '';
            switch (day.state) {
                case 0:
                    tips = '暂无补签功能，敬请期待';
            ...
            if (tips) {
                _vue2.default.utils.showTips(tips);
            }
        },
        //生成日期对应的月份的days
        initData: function initData(date, num) {
        ...
        //查询签到记录
        getSignDays: function getSignDays() {
            var _this = this;
            ...
            _vue2.default.api.postForm("/api/social/read/sign/signList", params, function (result) {
                ...
                if (result.data && result.data.signDayList) {
                    for (var i = 0; i < result.data.signDayList.length; i++) {
                        ...
                        for (var j = 0; j < _this.days.length; j++) {
                            if (_this.days[j].day && d.getDate() == _this.days[j].day) {
                                _this.days[j].state = 1;
                            }
                        }
                    }
                }
        ...
        sign: function sign() {
            ...
            //以form提交而不是json格式
            _vue2.default.api.postForm("/api/social/write/sign/doSign", params, function (result) {
                if (result.data) {
                    _this2.signYiBean = result.data.amount;
                    _this2.getSignDays();
                    _this2.getPoint();
                }
            }, function (result) {
        ...
        getPoint: function getPoint() {
            ...
            _vue2.default.api.get(url, params, function (res) {
                if (res.data) {
                    _this3.pointNum = res.data.pointBalance;
                }
            });
        }
    }

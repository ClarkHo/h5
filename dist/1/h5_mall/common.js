...
},{"../../../core/env/config.base":32,"lodash":128}],2:[function(require,module,exports){
"use strict";
...
},{"../../env/config.js":1,"./baiduHm.js":8,"./heimdall.js":16}],3:[function(require,module,exports){
"use strict";
...
var gateway = {
     ...
     * @param fn
     */
    getPriceStockList: function getPriceStockList(dataInput) {
        for (var _len = arguments.length, fn = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
            fn[_key - 1] = arguments[_key];
        }

        var mpIds = dataInput.mpIds,
            promotionType = dataInput.promotionType,
            items = dataInput.items,
            promotionLimitParams = dataInput.promotionLimitParams,
            url = _default2.default.apiHost + (promotionType ? '/gw/realTime/getPriceStockPromotionLimit' : '/gw/realTime/getPriceStockList'),
            data = void 0,
            fnS = fn[0],
            fnE = fn[1];
        //如果有商品列表
        ...
        if (mpIds) {
            mpIds = [mpIds].join(',').split(',').map(function (id) {
                return id - 0;
            });
        }
        //如果普通商品的mpIds为空,
     ...
     */
    getDolphin: function getDolphin(pageCode, adCode, fn) {
        var url = _default2.default.apiHost + '/gw/dolphin/list';
        var param = {
            platform: _default2.default.platform,
            pageCode: pageCode,
            adCode: adCode,
        ...
        var data = (0, _stringify2.default)(param);
        _vue2.default.api.get(url, { data: data }, function (res) {
            if (fn) {
                return fn(res);
            }
        }, function (res) {
     ...
     * pageCode: H5_HOME
     */
    getHomeDolphin: function getHomeDolphin(adCode, fn) {
...
_vue2.default.gateway = gateway;

},{"../config/default.js":31,"babel-runtime/core-js/get-iterator":33,"babel-runtime/core-js/json/stringify":34,"vue":undefined,"vue-resource":undefined}],4:[function(require,module,exports){
"use strict";
...
var ApiRequest = function () {
    ...
    (0, _createClass3.default)(ApiRequest, [{
        key: "get",
        value: function get(url, params, onsuccess, onerror) {
            var _this = this;

            this._startLoading();

            _vue2.default.http.get(this._getUrlWithParams(url, params)).then(function (response) {
                _this._endLoading();

                var result = response.data;

                if (_this.isSuccessful(response)) {
                    if (onsuccess) {
                        onsuccess(result);
                    }
                } else if (onerror) {
                    ...
                    _this._hanleError(result);
                }
            }, function (response) {
                _this._endLoading();
                _this._handleUnknownError(response);
            });
        }
        ...
        key: "postForm",
        value: function postForm(url, params, onsuccess, onerror) {
        ...
        key: "isSuccessful",
        value: function isSuccessful(response) {
        ...
        key: "_doPostRequest",
        value: function _doPostRequest(method, url, params, options, onsuccess, onerror) {
            var _this2 = this;

            _vue2.default.http.post(url, params, options).then(function (response) {
                var result = response.data;

                if (_this2.isSuccessful(response)) {
                    if (onsuccess) {
                        onsuccess(result);
                    }
                } else if (onerror) {
                    ...
                    _this2._hanleError(result);
                }
            }, function (response) {
                _this2._handleUnknownError(response);
            });
        }
        ...
        value: function _startLoading() {
            ...
            //延时200毫秒执行
            setTimeout(function () {
                if (_this3.loadingCount > 0 && !_this3.loadingElement) {
                    _this3.loadingElement = $.loading({ content: "加载中..." });

                    //设置超时10秒后自动隐藏loading mask
                    if (!_this3.timeoutMonitor) {
                        _this3.timeoutMonitor = setTimeout(function () {
                            _this3._clearLoading();
                        }, 10000);
                    }
                }
            }, 200);
        ...
        key: "_hanleError",
        value: function _hanleError(data) {
            //未登录弹出提示并跳转到登录页面
        ...
        value: function _handleUnknownError(response) {
        ...
        value: function _getUrlWithParams(url, params) {
            if (!params) {
                return url;
            }
...
//全局api变量
_vue2.default.api = new ApiRequest();
...
},{"babel-runtime/helpers/classCallCheck":42,"babel-runtime/helpers/createClass":43,"vue":undefined,"vue-resource":undefined}],5:[function(require,module,exports){
"use strict";
...
_vue2.default.app = {
     ...
     *  });
     */
    postMessage: function postMessage(func, params, callback) {
        //只有在app才执行
        if (!_vue2.default.browser.isApp()) {
            return;
        }
        ...
        if (_vue2.default.browser.ios()) {
            window.webkit.messageHandlers.mobileAPI.postMessage(msgParams);
        } else if (_vue2.default.browser.android()) {
            window.mobileAPI.postMessage((0, _stringify2.default)(msgParams));
        }
    },
    ...
    back: function back(refresh, forceBack) {
    ...
    logout: function logout() {
        window.location.href = "yh://logout";
    }
};

//统一隐藏app头部
if (_vue2.default.browser.isApp()) {
    _vue2.default.app.postMessage('hiddenHead', { 'isHidden': '1' });
}

},{"babel-runtime/core-js/json/stringify":34,"vue":undefined}],6:[function(require,module,exports){
'use strict';
...
_vue2.default.area = {
    ...
    getArea: function getArea() {
        ...
        if (_vue2.default.browser.isApp()) {
            ...
            if (!_vue2.default.localStorage.getItem('areaInfo')) {
                this.rePosition();
            } else {
                provinceName = _vue2.default.localStorage.getItem('areaInfo').province.name;
                areaCode = _vue2.default.localStorage.getItem('areaInfo').region.code;
            }
        }
    ...
    setArea: function setArea(pN, pC, cN, cC, rN, rC, flag) {
        this.areaInfo.province = { 'name': pN, 'code': pC };
        this.areaInfo.city = { 'name': cN, 'code': cC };
        this.areaInfo.region = { 'name': rN, 'code': rC };
        //保存区域
        if (flag == 1) {
            _vue2.default.localStorage.setItem('areaInfo', this.areaInfo);
        }
        //同时保存
        if (flag == 2) {
            _vue2.default.localStorage.setItem('areaInfo', this.areaInfo);
            _vue2.default.localStorage.setItem('curLocation', this.areaInfo);
        }
        //保存定位
        if (flag == 3) {
            _vue2.default.localStorage.setItem('curLocation', this.areaInfo);
    ...
    //获取销售区域默认配置
    getConfig: function getConfig(fun) {
        _vue2.default.api.get("" + "/api/commondata/getConfig", null, function (res) {
            if (res.data) {
                var param = { regionCode: res.data.defaultAreaCode || '310101' };
                _vue2.default.api.get("" + "/api/location/getCompleteAreaInfo", param, function (result) {
                    if (fun) {
                        fun(result.data);
                    }
                });
        ...
        if (typeof AMap != 'undefined') {
            ...
            map.plugin('AMap.Geolocation', function () {
                ...
                AMap.event.addListener(geolocation, 'complete', function (data) {
                    _vue2.default.area.onComplete(data);
                }); //返回定位信息
                AMap.event.addListener(geolocation, 'error', function (data) {
                    _vue2.default.area.onError(data);
                }); //返回定位出错信息
            });
        } else {
            _vue2.default.area.onError();
        }
    },
    ...
    getLocation: function getLocation(data) {
        ...
        _vue2.default.api.get(config.apiHost + '/api/location/getArea', param, function (res) {
            if (res.data) {
                _vue2.default.area.setArea(res.data.twoAddress, res.data.twoCode, res.data.thrAddress, res.data.thrCode, res.data.fouAddress, res.data.fouCode, 1);
            } else {
                this.getConfig(function (r) {
                    _vue2.default.area.setArea(r.provinceName, r.provinceCode, r.cityName, r.cityCode, r.regionName, r.regionCode, 1);
                });
            }
        });
    },
...
},{"vue":undefined}],7:[function(require,module,exports){
"use strict";
...
_vue2.default.auth = {
    ...
    getUserToken: function getUserToken() {
        ...
        var ut = _vue2.default.cookie.getCookie(this.utName);

        if (_vue2.default.browser.isApp()) {
            if (!ut) {
                //部分手机不能正常写入cookie
                ut = _vue2.default.browser.getUaParams().ut;
                if (ut) _vue2.default.cookie.setCookie(this.utName, ut);
            }
        }
        return ut;
    },
    ...
    getDistributorId: function getDistributorId() {
        return _vue2.default.cookie.getCookie(this.distributorId);
    },

    //设置分销商ID
    setDistributorId: function setDistributorId(type, id) {
        var dtype = _vue2.default.cookie.getCookie(this.distributorType);
        if (type >= dtype) {
            //优先级按照type大小  覆盖原有值
            _vue2.default.cookie.setCookie(this.distributorType, type);
            _vue2.default.cookie.setCookie(this.distributorId, id || '');
        }
    },

    //设置UT
    setUserToken: function setUserToken(ut) {
        _vue2.default.cookie.setCookie(this.utName, ut);
    },

    //清空用户登录UT
    //因为在iphone6 se版本的微信里无法删除cookie，所以只能通过设置为空来标识用户退出登录状态。
    deleteUserToken: function deleteUserToken() {
        _vue2.default.cookie.setCookie(this.utName, '');
    }
};
 ...
 */
_vue2.default.directive("needLogin", {
    priority: 3000,
    bind: function bind() {
...
},{"vue":undefined}],8:[function(require,module,exports){
'use strict';
...
_vue2.default.browser = {
    ...
    getUaParams: function getUaParams() {
    ...
    autoLogin: function autoLogin() {
        if (this.isApp()) {
            ...
            //ios 默认ut为default
            if (ut && ut != "default") {
                _vue2.default.auth.setUserToken(ut);
                _vue2.default.cookie.setCookie("ut", ut);
            }
        }
    },
    //获取ios浏览器主版本号
...
_vue2.default.browser.autoLogin();

},{"vue":undefined}],10:[function(require,module,exports){
(function (global){
"use strict";
      ...
      !function (i, r) {
        ...
        function n(e) {
          ...
          if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            ...
            r = "function" == typeof _symbol2.default && "symbol" == (0, _typeof3.default)(_iterator2.default) ? function (e) {
          ...
          function e(e, t) {
            for (var n = 0; n < t.length; n++) {
              var o = t[n];o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), (0, _defineProperty2.default)(e, o.key, o);
            }
      ...
      !function (i, r) {
        ...
        function i(e) {
          ...
          function e(e, t) {
            ...
            h = function (e) {
          function t(e, n) {
            r(this, t);var o = a(this, (t.__proto__ || (0, _getPrototypeOf2.default)(t)).call(this));return o.resolveOptions(n), o.listenClick(e), o;
...
},{"babel-runtime/core-js/object/create":36,"babel-runtime/core-js/object/define-property":37,"babel-runtime/core-js/object/get-prototype-of":38,"babel-runtime/core-js/object/set-prototype-of":39,"babel-runtime/core-js/symbol":40,"babel-runtime/core-js/symbol/iterator":41,"babel-runtime/helpers/typeof":45}],11:[function(require,module,exports){
"use strict";
...
var cookie = {
    ...
    delCookie: function delCookie(name) {
        ...
        while (domain.match(regDot).length > 1) {
            //清除多个子域名
...
_vue2.default.cookie = cookie;

},{"vue":undefined}],12:[function(require,module,exports){
"use strict";
 ...
 */
_vue2.default.filter('dateformat', function (value, fmt) {
 ...
 * 例子：2016-08-01
 */
_vue2.default.filter("date", function (date) {
    if (date) {
        var d = new Date(date);
...
_vue2.default.filter("datedot", function (date) {
    if (date) {
        var d = new Date(date);
        var arr = [d.getFullYear(), fmtNum(d.getMonth() + 1), fmtNum(d.getDate())];
        return arr.join(".");
...
_vue2.default.filter("date2", function (date) {
    if (date) {
        var d = new Date(date);
        var arr = [d.getFullYear(), fmtNum(d.getMonth() + 1), fmtNum(d.getDate())];
        return arr.join(".");
...
_vue2.default.filter("preSellTime", function (date) {
    if (date) {
        var d = new Date(date);
...
_vue2.default.filter("time", function (date) {
    if (date) {
        var d = new Date(date);
...
_vue2.default.filter("time2", function (date) {
    if (date) {
        var d = new Date(date);
...
_vue2.default.filter("dateTime", function (date) {
...
_vue2.default.filter("relativeTime", function (date) {
    if (!date) {
        return "";
    }
...
_vue2.default.filter("dateMDMS", function (date) {
    if (date) {
        var d = new Date(date);
...
},{"vue":undefined}],13:[function(require,module,exports){
"use strict";
...
_vue2.default.filter("reverseArray", function (value, ignore) {
    "use strict";
...
_vue2.default.filter('cut', function (input, left) {
    var _in;
    if (_in = (input || 0) - 0) {
        _in = _in.toFixed(2);
...
_vue2.default.filter('afterSaleType', function (value) {
    switch (value) {
        case 1:
            return "退款";
        case 2:
...
_vue2.default.filter("hundredCut", function (money) {
    var moneyTemp = money;
    if (!money) return '0';
    if (money / 10000 < 1) {
        return money;
...
_vue2.default.filter('specialMoney', function (value) {
    var newValue = (value * 100).toString();

    if (newValue < 10) {
        newValue = '0' + newValue;
    }

    var intNum = newValue.substr(0, newValue.length - 2) == '' ? '0' : newValue.substr(0, newValue.length - 2);

    var flaotNum = newValue.substr(newValue.length - 2);

    return "<span class='f12 mgR2'>¥</span><span class='f20'>" + intNum + "</span>.<span class='f15'>" + flaotNum + "</span>";
});
//订单状态过滤
_vue2.default.filter('orderStatus', function (value) {
    switch (value) {
        case 1:
            return "待付款";
        case 2:
...
_vue2.default.filter('numToString', function (value) {
    switch (value) {
        case 1:
            return "一";break;
        case 2:
...
// 去掉数据的前后空格
_vue2.default.filter('selectItrim', function (value) {
    var str = trim(value);
    return str;
});
//数组转换成string,系列属性专用
_vue2.default.filter('arryToString', function (value) {
    var arr = [];
    if (value && value instanceof Array) {
        value.forEach(function (sa) {
            arr.push(sa.attrVal);
        });
    }
...
//过滤数组
_vue2.default.filter('filterIgnore', function (attrs, ig, property) {
    "use strict";
...
_vue2.default.filter('phoneFilter', function (val) {
    if (val) {
 ...
 */
_vue2.default.filter('datetime', function (date, format) {
    "use strict";

    var weeks = ['周日', '周一', '周二', '周三', '周四', '周五', '周六'];
    if (!date) return '';else if ((format || '').length == 0) return _vue2.default.filter('date')(date);else {
        var t = new Date(date);
        var y = t.getYear() + 1900,
            ...
            m = t.getMinutes(),
            s = t.getSeconds();
        return format.replace(/(yyyy|YYYY)/, y).replace(/MM/, M > 9 ? M : '0' + M).replace(/(dd|DD)/, d > 9 ? d : '0' + d).replace(/hh/, h > 9 ? h : '0' + h).replace(/mm/, m > 9 ? m : '0' + m).replace(/ss/, s > 9 ? s : '0' + s).replace(/M/, M).replace(/(w|W)/, weeks[w]).replace(/h/, h).replace(/m/, m).replace(/s/, s);
    }
});
/**
 ...
 */
_vue2.default.filter('imgSize', function (url, size, q) {
    //非正常状态
    ...
    _size = size.toLowerCase(),
        ...
        reg1_1 = new RegExp('(http://images\\.laiyifen\\.com.*)_[sml](\\.jpg|\\.jpeg|\\.png|\\.gif)(\\?v.*)?$', 'i'),
        //来伊份格式_切过
    reg1_2 = new RegExp('(http://images\\.laiyifen\\.com.*)(\\.jpg|\\.jpeg|\\.png|\\.gif)$', 'i'),
        //来伊份格式_原图
    reg2_1 = new RegExp('(http://cdn\\.oudianyun\\.com.*|http://ds\\.cdn\\.oudianyun\\.com.*|http://ody\\.cdn\\.oudianyun\\.com.*)(\\.jpg|\\.jpeg|\\.png|\\.gif)(@base.*)', 'i'),
        //金山云格式_切过
...
//千分隔断 两位小数
_vue2.default.filter('numSeparator', function (val) {
    var int, num;
    if (!val) {
        return 0;
    } else {
...
},{"vue":undefined}],15:[function(require,module,exports){
"use strict";
...
//alias，方便页面js使用
_vue2.default.event = eventSupport;

},{"vue":undefined}],16:[function(require,module,exports){
'use strict';
...
function heimdallPageLoad(params) {
    ...
    window._heimdall.appKey = 'dbd14281-6e3d-46c2-8672-45a3e2156f7d';
    window._heimdall.appSecret = '1494F325C96B41FAAE490637B8DAA0ED';
    window._heimdall.productLine = '859133073'; //产品线id
    window._heimdall_config_serverhost = '';
    if (_vue2.default.browser.weixin()) {
        window._heimdall.fs = 3;
    } else {
        window._heimdall.fs = '';
    }
    window._heimdall.ut = document.cookie.match(/;?\s*ut=(\w+);/i) && document.cookie.match(/;?\s*ut=(\w+);/i)[1] || null;;
    if (params) {
        (0, _assign2.default)(window._heimdall, params);
    }
    vds = document.createElement('script');
    vds.type = 'text/javascript';
    vds.async = true;
    vds.src = "/horse-core/heimdall-web/heimdall-bi/heimdall-basic-news.js";
    //TODO:script为啥放第一个
...
module.exports = function heimdall() {
    // debugger;
    /**
     * 发送基本事件 ev取以下值
     * viewHomePage:0 首页
        ...
        window.eventSupport.on('heimdallTrack', function (params) {
            ...
            function isHeimdallLoaded() {
                if (window.heimdall_track && typeof window.heimdall_track === 'function') {
                    ...
                    par = (0, _assign2.default)({ ut: ut }, params);
                    heimdall_track(par);
                    return;
                }
...
},{"babel-runtime/core-js/object/assign":35,"vue":undefined}],17:[function(require,module,exports){
"use strict";
 ...
 */
_vue2.default.directive("linkTo", {
    bind: function bind() {
 ...
 */
_vue2.default.directive("linkToUserpage", {
    bind: function bind() {
        this.handler = function () {
            if (_vue2.default.auth.loggedIn()) {
                window.location.href = this.url;
 ...
 */
_vue2.default.directive("linkToWebapp", {
    bind: function bind() {
        this.handler = function () {
            if (_vue2.default.browser.isApp()) {
                //跳转到app登录页面
 ...
 */
_vue2.default.directive("linkToItem", {
    bind: function bind() {
        this.handler = function () {
            var url;
            if (!this.itemId) {
            ...
            if (_vue2.default.browser.isApp()) {
                url = 'yh://productdetail?body={"mpId":' + this.itemId + '}';
            } else {
 ...
 */
_vue2.default.directive("linkToPay", {
    bind: function bind() {
        this.handler = function () {
            var url;
            if (_vue2.default.browser.isApp()) {
                ...
                };url = 'yh://pay?body={"orderType":"' + (this.order.groupBuyOrderCode ? '2' : '') + '","orderCode":"' + this.order.orderCode + '","amount":' + this.order.paymentAmount + ', "url": "' + _vue2.default.utils.getPayBackUrl(this.order.orderCode + (this.order.groupBuyOrderCode ? '_' + this.order.groupBuyOrderCode : '')) + '"}';
            } else {
                // url =  "/pay/pay-way.html?orderCode="+ this.order.orderCode + (this.order.groupBuyOrderCode ? '_' + this.order.groupBuyOrderCode:'');
                url = _vue2.default.utils.getPayUrl(this.order.orderCode + (this.order.groupBuyOrderCode ? '_' + this.order.groupBuyOrderCode : ''), '&paystate=1');
            }
            window.location.href = url;
        }.bind(this);
 ...
 */
_vue2.default.directive("linkToAddress", {
    bind: function bind() {
        this.handler = function () {
            var url;
            if (_vue2.default.browser.isApp()) {
...
},{"vue":undefined}],18:[function(require,module,exports){
'use strict';
...
_vue2.default.loading = new Loading();

},{"babel-runtime/helpers/classCallCheck":42,"babel-runtime/helpers/createClass":43,"vue":undefined}],19:[function(require,module,exports){
"use strict";
...
var LocalStorageWrapper = function () {
    function LocalStorageWrapper() {
        (0, _classCallCheck3.default)(this, LocalStorageWrapper);
    ...
    (0, _createClass3.default)(LocalStorageWrapper, [{
        key: "getItem",
        ...
        value: function setItem(key, value) {
            this.localStorage[key] = (0, _stringify2.default)(value);
        }
...
_vue2.default.localStorage = new LocalStorageWrapper();

},{"babel-runtime/core-js/json/stringify":34,"babel-runtime/helpers/classCallCheck":42,"babel-runtime/helpers/createClass":43,"vue":undefined}],20:[function(require,module,exports){
"use strict";
...
var companyId = frontTemplate ? frontTemplate.companyId : 1001;

/**
 * 商城配置
 */

var MallSettings = function () {
    //构造函数
    //onLoad setting加载完后执行的回调函数
    function MallSettings(onLoad) {
        (0, _classCallCheck3.default)(this, MallSettings);
    ...
    (0, _createClass3.default)(MallSettings, [{
        key: "getMallName",
        value: function getMallName() {
        ...
        key: "getMallCopyright",
        value: function getMallCopyright() {
        ...
        key: "_getSetting",
        value: function _getSetting(settingName) {
        ...
        value: function _loadSettings() {
            ...
            var localSettings = _vue2.default.localStorage.getItem(this.settingsKey);
            var expired = false;
            //检测settings是否过期
            if (_vue2.default.localStorage.contains(this.expireDateKey)) {
                var expDate = new Date(_vue2.default.localStorage.getItem(this.expireDateKey));
                var now = new Date();
            ...
            _vue2.default.api.post("/osc-api/getMobileMallBasicSetting.do", params, function (result) {
                _this.settings = result.resultData || {};
                _vue2.default.localStorage.setItem(_this.settingsKey, _this.settings);
                _vue2.default.localStorage.setItem(_this.expireDateKey, _this._getExpireDate());
        ...
        key: "_getWeixinAppId",
        value: function _getWeixinAppId(cb) {
            var _this2 = this;

            var appId = _vue2.default.localStorage.getItem(this.appIdKey);
            var expired = false;
            //检测settings是否过期
            if (_vue2.default.localStorage.contains(this.appIdexpireDateKey)) {
                var expDate = new Date(_vue2.default.localStorage.getItem(this.appIdexpireDateKey));
                var now = new Date();
            ...
            _vue2.default.api.postForm("/opay-web/getWxpayAppId.do", params, function (result) {
                _this2.settings['appId'] = result.data.appId;
                if (typeof cb == 'function') {
                    cb(appId);
                }
                _vue2.default.localStorage.setItem(_this2.appIdKey, result.data.appId);
                _vue2.default.localStorage.setItem(_this2.appIdexpireDateKey, _this2._getExpireDate());
            }, function () {
                // 拦截接口提示信息
            });
        }
...
_vue2.default.mallSettings = new MallSettings(function (mallSettings) {
    document.title = mallSettings.getMallName() || "SAAS商城";
});

},{"../../env/config.js":1,"babel-runtime/helpers/classCallCheck":42,"babel-runtime/helpers/createClass":43,"vue":undefined}],21:[function(require,module,exports){
'use strict';
...
},{"vue":undefined}],22:[function(require,module,exports){
"use strict";
...
//记录滚动条的位置
var POS_PREFIX = "scroll_pos_";
//记录相关的数据
var DATA_PREFIX = "scroll_data_";
//记录当前的url
var URL_PREFIX = "scroll_url_";
//记录存储数据的时间
var TIME_PREFIX = "scroll_time_";
//默认数据过期时间 (2分钟)
var EXPIRE_TIME = 1000 * 60 * 2;

/**
 * 恢复页面的保存的状态并且恢复滚动条的位置
 */

var PageRestorer = function () {
    function PageRestorer() {
        (0, _classCallCheck3.default)(this, PageRestorer);
    }

    (0, _createClass3.default)(PageRestorer, [{
        key: "init",
         ...
         */
        value: function init(vm, page, expireTime) {
            var _this = this;
            ...
            $(window).on("scroll", function () {
                window.sessionStorage[_this.posKey] = document.body.scrollTop;
                window.sessionStorage[_this.urlKey] = window.location.href;
                window.sessionStorage[_this.dataKey] = (0, _stringify2.default)(vm.$data);
                window.sessionStorage[_this.timeKey] = new Date().getTime();
            });
        }
        ...
        value: function restore() {
            ...
            if (pos > 0 && url == window.location.href) {
                var cachedData = this.getData();
                var expiredTime = this.getTime() + this.expireTime;
                var now = new Date().getTime();
                //不处理已过期的数据
        ...
        value: function getData() {
            var data = window.sessionStorage[this.dataKey];
        ...
        value: function getTime() {
            var t = window.sessionStorage[this.timeKey];
...
_vue2.default.pageRestorer = new PageRestorer();

},{"babel-runtime/core-js/json/stringify":34,"babel-runtime/helpers/classCallCheck":42,"babel-runtime/helpers/createClass":43,"vue":undefined}],23:[function(require,module,exports){
"use strict";
...
// 获取实时价格库存
_vue2.default.getPriceAndStock = function (mpIds, obj, promotionId, callback) {
    "use strict";
    ...
    _vue2.default.api.get(url, param, function (res) {
        ...
        try {
            for (var _iterator = (0, _getIterator3.default)(res.data.plist || []), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var pl = _step.value;
...
// 获取积分商品实时价格库存
_vue2.default.getPointProPriceAndStock = function (mpIds, obj, promotionId, callback) {
    "use strict";
    ...
    _vue2.default.api.get(url, param, function (res) {
        ...
        try {
            for (var _iterator4 = (0, _getIterator3.default)(obj || []), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var _pl2 = _step4.value;

                if (plistMap[_pl2.mpId]) {
                    $.extend(_pl2, plistMap[_pl2.mpId]);
                }
            }
        } catch (err) {
...
},{"../../env/config.js":1,"babel-runtime/core-js/get-iterator":33,"vue":undefined}],24:[function(require,module,exports){
"use strict";
 ...
 */
_vue2.default.scrollLoading = function (options) {
    //只有回调函数，其他参数默认。
    ...
    var triggerHeight = options.triggerHeight || 100;
    var callback = options.callback;
    var parentEl = options.parentEl || window; //父容器，用于局部滚动加载
    var childEl = options.childEl || document; //子容器，用于局部滚动加载
    var busy = false;
...
},{"vue":undefined}],25:[function(require,module,exports){
"use strict";
 ...
 * 返回顶部
 */
_vue2.default.directive('scroll-top', {
    bind: function bind() {
        this.handler = function () {
...
$(function () {
    ...
    function showXiaoNeng(data) {
        var itemId = '';
        var uid = _vue2.default.auth.getUserToken();
        var username = localStorage.username;
        if (_vue2.default.utils.getRelatedUrl().indexOf('/detail.html') == 0) {
            itemId = _vue2.default.utils.paramsFormat(location.href).itemId;
        }
        ...
        window.NTKF_PARAM = {
            ...
            "itemid": itemId,
            "itemparam": _config2.default.platformId
        };
    ...
    function hideXiaoneng() {
        var excludes = ["/weixin/share.html", "/detail.html"];
    ...
    function getXnConfig(name, code) {
        if (sessionStorage[name]) {
            ...
            var url = _config2.default.apiHost + '/search-backend-web/getCustomerSiteInfo.json';
            var param = {
                merchantId: -99,
                platformId: 0,
            ...
            _vue2.default.api.get(url, param, function (res) {
                if (res.data && res.data.siteId && res.data.settingId) {
                    sessionStorage[name] = (0, _stringify2.default)(res.data);
    ...
    if (!_vue2.default.browser.isApp() && !hideXiaoneng()) {
        var page = _vue2.default.utils.getRelatedUrl();
...
},{"../../env/config.js":1,"babel-runtime/core-js/json/stringify":34,"vue":undefined}],26:[function(require,module,exports){
"use strict";
 ...
 * 操作用户客户端session id
 */
_vue2.default.session = {
    //用户的session id 名称
    sidName: "sessionId",

    //获取用户session id， 如果没有生成一个。
    getSessionId: function getSessionId() {
        var sid = _vue2.default.cookie.getCookie(this.sidName);
        ...
        if (!sid) {
            ...
            _vue2.default.cookie.setCookie(this.sidName, sid);
        }
    ...
    //删除session id
    deleteSessionId: function deleteSessionId() {
        _vue2.default.cookie.delCookie(this.sidName);
    }
};

},{"vue":undefined}],27:[function(require,module,exports){
"use strict";
...
var SessionStorageWrapper = function () {
    function SessionStorageWrapper() {
        (0, _classCallCheck3.default)(this, SessionStorageWrapper);
    ...
    (0, _createClass3.default)(SessionStorageWrapper, [{
        key: "getItem",
        value: function getItem(key) {
            if (this.contains(key)) {
        ...
        key: "setItem",
        value: function setItem(key, value) {
            this.sessionStorage[key] = (0, _stringify2.default)(value);
        }
...
_vue2.default.sessionStorage = new SessionStorageWrapper();

},{"babel-runtime/core-js/json/stringify":34,"babel-runtime/helpers/classCallCheck":42,"babel-runtime/helpers/createClass":43,"vue":undefined}],28:[function(require,module,exports){
"use strict";
...
_vue2.default.getSysTime = function (fun) {
    "use strict";

    var url = "" + '/api/realTime/getTimestamp?nocache=' + new Date().getTime();
    _vue2.default.api.get(url, null, function (res) {
        if (fun) {
            fun(res);
        }
    });
...
},{"../../env/config.js":1,"vue":undefined}],29:[function(require,module,exports){
"use strict";
...
var utils = (_utils = {
     ...
     */
    getRelatedUrl: function getRelatedUrl() {
     ...
     * 根据团单号构造去支付url
     */
    getPayUrl: function getPayUrl(orderCode, param) {

        var prefix = this.getHost();
        var url = (_config2.default.wx302Url || prefix) + "/pay/pay-way.html?orderCode=" + orderCode + (param || '');

        if (_vue2.default.browser.weixin()) {
            url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + _vue2.default.mallSettings.getAppId() + "&redirect_uri=" + encodeURIComponent(url) + "&response_type=code&scope=snsapi_base&state=123&connect_redirect=1#wechat_redirect";
        }
     ...
     */
    getPayBackUrl: function getPayBackUrl(orderCode) {
        var url = location.protocol + "//" + location.host;
        if (location.port) {
            url += ":" + location.port;
        }
     ...
     */
    paramsFormat: function paramsFormat(url) {
     ...
     * param : 秒
     */
    getHhmmss: function getHhmmss(time) {
        time = parseInt(time);
        if (time <= 0) time = 0;
     ...
     */
    hashFormat: function hashFormat(url) {
        var hashObj = {};
    ...
    safeMode: function safeMode(fn) {
        ...
        return function () {
            ...
            return (_fn2 = _fn).call.apply(_fn2, [_this].concat(args));
        };
    },
    /**
     * 对象合并
...
}, (0, _defineProperty3.default)(_utils, "showTips", function showTips(msg) {
    $.tips({
        content: msg,
        stayTime: 2000,
        type: "info"
    });
}), (0, _defineProperty3.default)(_utils, "goLogin", function goLogin(callback) {
    if (_vue2.default.auth.loggedIn()) {
...
}), (0, _defineProperty3.default)(_utils, "quickPurchase", function quickPurchase(obj, failCall, ignore) {
    var params = obj;
    if (_vue2.default.cookie.getCookie('shareCode')) {
        params.shareCode = _vue2.default.cookie.getCookie('shareCode');
    }
    if (ignore) params.ignoreChange = 1;

    //第二版快速购买，结算页初始化订单

    _vue2.default.localStorage.setItem('quick_buy', params);
    ...
    //     }
    // });
}), (0, _defineProperty3.default)(_utils, "safeDomainCheck", function safeDomainCheck(url, cb) {
    if (!url || /^\//.test(url)) return;
    // var safeDamain = ('${safeDamain}' || '').split(','),
    var safeDamain = ('${safeDamain}' || '').split(','),
        safeRegx = [],
        flag = false;
    safeDamain.forEach(function (v) {
...
}), (0, _defineProperty3.default)(_utils, "convertToString", function convertToString(obj) {
...
}), (0, _defineProperty3.default)(_utils, "isRepeat", function isRepeat(str, subString, reg) {
    var rege = reg ? reg : new RegExp(subString, 'ig');
    return str.match(rege).length > 1;
}), _utils);

_vue2.default.utils = utils;

},{"../../env/config.js":1,"babel-runtime/core-js/object/assign":35,"babel-runtime/helpers/defineProperty":44,"babel-runtime/helpers/typeof":45,"vue":undefined}],30:[function(require,module,exports){
"use strict";
...
//调用getUnionId的页面
var SKEY_INVOLKEPAGE = "s_invokepage";
//是否是在微信里首次打开h5页面
var SKEY_ACCESSED = "s_accessed";
//微信用户信息
var SKEY_WXUSERINFO = "s_wxuserinfo";

//当前用户的shareCode
var SKEY_SHARECODE = "s_currentsharecode";

//不处理的页面 
var excludePages = ["/share.html", "/feedback/feedback.html", "/my/share-article-detail.html", "/download.html"];

//取消分享朋友圈的页面
var regPage = /\/(cut|group|my)\//;

//这些my目录下的页面允许分享到朋友圈
var shareablePages = ["/my/market-article-detail.html", "/my/share-article-detail.html"];
...
var weixin = {
    ...
    excludeCurrentPage: function excludeCurrentPage() {
        var path = location.pathname;
    ...
    checkShareCode: function checkShareCode() {
        //不处理分享页面
        if (this.excludeCurrentPage()) {
            return;
        }

        var urlParams = _vue2.default.utils.paramsFormat(location.href);
        var hashParams = _vue2.default.utils.hashFormat(location.href);
        //缓存的上家的shareCode
        //FIXME 上家的sharecode key要用常量并注释
        var s_shareCode = _vue2.default.cookie.getCookie("shareCode");
        ...
        //自己的shareCode的
        var ownShareCode = _vue2.default.sessionStorage.getItem(SKEY_SHARECODE);
        //如果url里有上家的shareCode，且自己本地没有存shareCode，就保存上家的shareCode，在注册，预绑定，联合登录场景使用
        if (shareCode && !s_shareCode && shareCode != ownShareCode) {
            _vue2.default.cookie.setCookie("shareCode", shareCode);
        }
        this.rewrite();
    },
    ...
    getWxUserInfo: function getWxUserInfo() {
        return _vue2.default.sessionStorage.getItem(SKEY_WXUSERINFO) || {};
    },

    //处理url里的上家分享码并保存进cookie
    processInviterShareCode: function processInviterShareCode() {
        var urlParams = _vue2.default.utils.paramsFormat(location.href);
        var hashParams = _vue2.default.utils.hashFormat(location.href);
        //缓存的上家的shareCode
        var s_shareCode = _vue2.default.distribution.getInviterShareCode();
        //1. 获取url里的sharecode，复制链接的shareCode是在hash里，分享朋友圈的shareCode是在url里的
        // 当前url里带的上家的shareCode
        var shareCode = hashParams.shareCode || urlParams.shareCode;
        //2.  本人的shareCode要和url里的shareCode比较，如果相同就不处理
        //自己的shareCode
        var ownShareCode = _vue2.default.distribution.getCurUserShareCode();
        //如果url里有上家的shareCode，且自己本地没有存shareCode，就保存上家的shareCode，在注册，预绑定，联合登录场景使用
        if (shareCode && !s_shareCode && shareCode != ownShareCode) {
            _vue2.default.distribution.setInviterShareCode(shareCode);
        }
    },
     ...
     * 在微信里进行预绑定处理
     */
    doPreBinding: function doPreBinding() {
        //已经预绑定过,直接返回        
        if (this.getUnionid()) {
            return;
        }

        var accessed = _vue2.default.sessionStorage.getItem(SKEY_ACCESSED);
        var urlParams = _vue2.default.utils.paramsFormat(location.href);
        //如果不是首次访问，并且页面带了code就存储起来(通过微信走了一圈回来)就进行预绑定
        if (accessed && urlParams.code) {
            var inviterShareCode = _vue2.default.distribution.getInviterShareCode() || "";
            ...
            _vue2.default.api.postForm("/agent-wx-web/weixinShare/getWxUserInfo.do", params, function (result) {
                var data = result.data;
                if (data) {
                    _vue2.default.sessionStorage.setItem(SKEY_WXUSERINFO, data);
                    _vue2.default.event.emit("updateWeixinUserInfo");
                }
            }, function () {
                //预绑定出错暂不处理
            });
            ...
            //设置已访问的标志
            _vue2.default.sessionStorage.setItem(SKEY_ACCESSED, true);
            //走微信静默授权
            this.doWeixinAuth();
        }
    },
     ...
     * 通过微信静默授权获得code
     */
    doWeixinAuth: function doWeixinAuth() {
        //如果当前页已经走过一次静默授权流程，直接返回 (避免死循环)
        if (location.pathname == _vue2.default.sessionStorage.getItem(SKEY_INVOLKEPAGE)) {
            _vue2.default.sessionStorage.removeItem(SKEY_INVOLKEPAGE);
            return;
        }

        //记录当前页面已经请求过微信授权，避免多次请求。
        _vue2.default.sessionStorage.setItem(SKEY_INVOLKEPAGE, location.pathname);
        var redirectUrl = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + _vue2.default.mallSettings.getAppId() + '&redirect_uri=' + encodeURIComponent(location.href) + '&response_type=code&scope=snsapi_base&state=1#wechat_redirect';
     ...
     */
    rewriteUrl: function rewriteUrl() {
        //有可能包含的是上家的shareCode
        var hashParams = _vue2.default.utils.hashFormat(location.href);
        var urlParams = _vue2.default.utils.paramsFormat(location.href);
        ...
        //本地有缓存，或者接口返回成功才有
        var shareCode = _vue2.default.sessionStorage.getItem(SKEY_SHARECODE);
        if (shareCode) {
        ...
        var hashStr = _vue2.default.utils.convertToString(hashParams);
        if (hashStr) {
            //微信里只能更改hash的值，这里使用hash追踪分享人的信息
            location.hash = "#" + hashStr;
        }

        var urlStr = _vue2.default.utils.convertToString(urlParams);
        if (urlStr) {
            var url = _vue2.default.utils.getHost() + location.pathname + '?' + urlStr;
    ...
    rewrite: function rewrite() {
        ...
        if (_vue2.default.sessionStorage.getItem(SKEY_SHARECODE)) {
            this.rewriteUrl();
        } else {
            this.loadCurrentDistributionData(function () {
                _this.rewriteUrl();
            }, function () {
                //获取shareCode失败
                $.tips({
    ...
    /**
      ...
      */
    updateUrlForShare: function updateUrlForShare() {
        var _this2 = this;

        if (_vue2.default.distribution.getCurUserShareCode()) {
            this.rewriteUrl();
        } else {
            //获取当前用户分销信息
            _vue2.default.distribution.loadCurrentDistributionData(function () {
                _this2.rewriteUrl();
            }, function () {
                _this2.rewriteUrl();
            });
     ...
     * 判断当前页面是不是显示微信的分享功能
     */
    isShareablePage: function isShareablePage() {
        var path = location.pathname;
    ...
    initWeixinShare: function initWeixinShare() {
        if (_vue2.default.browser.weixin()) {
            var url = '/api/weixin/getSign?url=' + encodeURIComponent((location.href + '#').split('#')[0]);
            _vue2.default.api.get(url, null, function (res) {
                if (typeof wx != 'undefined') {
                    _vue2.default.mallSettings._getWeixinAppId(function (appId) {
                        wx.config({
                            debug: false, // 开启调试模式,调用的所有api的返回值会在客户端alert出来，若要查看传入的参数，可以在pc端打开，参数信息会通过log打出，仅在pc端时才会打印。
                            appId: _vue2.default.mallSettings.getAppId(), // 必填，公众号的唯一标识
     ...
     */
    weixinShare: function weixinShare(data, callback) {
        if (_vue2.default.browser.weixin() && typeof wx != 'undefined') {
            wx.ready(function () {
    ...
    //清除用户的分销商信息
    clearDistributionData: function clearDistributionData() {
        _vue2.default.sessionStorage.removeItem('distributorId');
        _vue2.default.sessionStorage.removeItem('distributorType');
        _vue2.default.sessionStorage.removeItem('currDistributor');
        _vue2.default.sessionStorage.removeItem('s_currentsharecode');
    },

    /**
     * 重新获取并设置用户的分销商信息
     */
    loadCurrentDistributionData: function loadCurrentDistributionData(callback, failCallback) {
        var url = '/api/seller/distributor/currDistributor';
        var param = {
            ut: _vue2.default.auth.getUserToken(),
            unionid: _vue2.default.weixin.getUnionid(),
            shareCode: _vue2.default.cookie.getCookie("shareCode")
        };

        _vue2.default.api.get(url, param, function (res) {
            var data = res.data;
            if (data && data.id) {
                _vue2.default.auth.setDistributorId(2, data.id);
                _vue2.default.sessionStorage.setItem('currDistributor', data);

                if (data.shareCode) {
                    _vue2.default.sessionStorage.setItem('s_currentsharecode', data.shareCode);
                }
            }
...
_vue2.default.weixin.weixinShare({
    ...
    title: _vue2.default.mallSettings.getMallName(),
    desc: 'SASS官方商城',
    imgUrl: _config2.default.share.defaultImg
});
// Vue.weixin.checkShareCode();

},{"../../env/config.js":1,"vue":undefined}],31:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/defineProperty":44}],33:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/get-iterator"), __esModule: true };
},{"core-js/library/fn/get-iterator":46}],34:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":47}],35:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/assign"), __esModule: true };
},{"core-js/library/fn/object/assign":48}],36:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/create"), __esModule: true };
},{"core-js/library/fn/object/create":49}],37:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":50}],38:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/get-prototype-of"), __esModule: true };
},{"core-js/library/fn/object/get-prototype-of":51}],39:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/set-prototype-of"), __esModule: true };
},{"core-js/library/fn/object/set-prototype-of":52}],40:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/symbol"), __esModule: true };
},{"core-js/library/fn/symbol":53}],41:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/symbol/iterator"), __esModule: true };
},{"core-js/library/fn/symbol/iterator":54}],42:[function(require,module,exports){
"use strict";
...
},{"../core-js/symbol":40,"../core-js/symbol/iterator":41}],46:[function(require,module,exports){
require('../modules/web.dom.iterable');
require('../modules/es6.string.iterator');
module.exports = require('../modules/core.get-iterator');

},{"../modules/core.get-iterator":115,"../modules/es6.string.iterator":123,"../modules/web.dom.iterable":127}],47:[function(require,module,exports){
...
},{"../../modules/_core":61}],48:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/_core').Object.assign;

},{"../../modules/_core":61,"../../modules/es6.object.assign":117}],49:[function(require,module,exports){
...
},{"../../modules/_core":61,"../../modules/es6.object.create":118}],50:[function(require,module,exports){
...
},{"../../modules/_core":61,"../../modules/es6.object.define-property":119}],51:[function(require,module,exports){
require('../../modules/es6.object.get-prototype-of');
module.exports = require('../../modules/_core').Object.getPrototypeOf;

},{"../../modules/_core":61,"../../modules/es6.object.get-prototype-of":120}],52:[function(require,module,exports){
require('../../modules/es6.object.set-prototype-of');
module.exports = require('../../modules/_core').Object.setPrototypeOf;

},{"../../modules/_core":61,"../../modules/es6.object.set-prototype-of":121}],53:[function(require,module,exports){
...
},{"../../modules/_core":61,"../../modules/es6.object.to-string":122,"../../modules/es6.symbol":124,"../../modules/es7.symbol.async-iterator":125,"../../modules/es7.symbol.observable":126}],54:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
module.exports = require('../../modules/_wks-ext').f('iterator');

},{"../../modules/_wks-ext":112,"../../modules/es6.string.iterator":123,"../../modules/web.dom.iterable":127}],55:[function(require,module,exports){
...
},{"./_export":68,"./_hide":72,"./_iter-create":78,"./_iterators":81,"./_library":82,"./_object-gpo":92,"./_redefine":98,"./_set-to-string-tag":100,"./_wks":113}],80:[function(require,module,exports){
...
},{"./_core":61,"./_global":70,"./_library":82}],103:[function(require,module,exports){
...
},{"./_object-gpo":92,"./_object-sap":96,"./_to-object":108}],121:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require('./_export');
$export($export.S, 'Object', { setPrototypeOf: require('./_set-proto').set });

},{"./_export":68,"./_set-proto":99}],122:[function(require,module,exports){
...
},{"./_iter-define":79,"./_string-at":103}],124:[function(require,module,exports){
'use strict';
...
},{"./_an-object":57,"./_descriptors":64,"./_enum-keys":67,"./_export":68,"./_fails":69,"./_global":70,"./_has":71,"./_hide":72,"./_is-array":76,"./_is-object":77,"./_library":82,"./_meta":83,"./_object-create":85,"./_object-dp":86,"./_object-gopd":88,"./_object-gopn":90,"./_object-gopn-ext":89,"./_object-gops":91,"./_object-keys":94,"./_object-pie":95,"./_property-desc":97,"./_redefine":98,"./_set-to-string-tag":100,"./_shared":102,"./_to-iobject":106,"./_to-primitive":109,"./_uid":110,"./_wks":113,"./_wks-define":111,"./_wks-ext":112}],125:[function(require,module,exports){
...
},{"./_global":70,"./_hide":72,"./_iterators":81,"./_wks":113,"./es6.array.iterator":116}],128:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{}]},{},[27,19,11,13,7,9,29,4,20,26,2,3,5,6,8,10,12,14,15,16,17,18,21,22,23,24,25,28,30]);

...
vm = new Vue({
    ...
    methods: {
        ...
        getPlaceHoder:function(){
            "use strict";
            var url = config.apiHost + '/back-merchant-web/api/merchant/trendingKeywords.do';
            var param = {
        ...
        loadSearchList: function (load) {
            ...
            Vue.api.get(url, param, (res) => {
                ...
                if(this.totalCount==0){
                    ...
                    if(this.zeroRecommendResult.length==0 && this.maybeInterestedKeywords.length == 0){
                        this.getPlaceHoder();
                    }
                }else {
        ...
        clickAutoFill: function (str) {
            ...
            str = str.replace(/[ | ]*\n/g,'\n'); //去除行尾空白
            window.location.href = config.contextPath + "/store/search.html?keyword=" + str;
        },
        ...
        getFootList: function () {
            ...
            Vue.api.get("/api/my/foot/list", params, (res) => {
                ...
                this.footList = this.footList.concat(temp);
                this.resizeImgHeight();

...
var vm = new Vue({
    ...
    data: {
        ...
        setname:"",
        inviteUserLimit:"",
        shareCode8:Vue.cookie.getCookie('shareCode8'),//邀请好友登录判断
        getShareLink:"/regis.html"
    },
    //存储亲友号数据
    created:function(){
    	function getQueryString(name) {   
         ...
         this.friend=getQueryString('setName')     
    },
    ...
    methods: {
        getShareCode:function(){
            if(urlParams.shareCode){
                ...
                this.getShareLink="/regis.html?shareCode="+decodeURI(urlParams.shareCode)+"&shareName="+decodeURI(urlParams.shareName)
            }
        },
        //检查是否支持分销功能
        ...
        checkBtnDisabled: function () {
            ...
            /*if(!/^(13|15|17|18|14)[0-9]{9}$/.test(this.username)) {
        ...
        login: function () {
            ...
            Vue.api.postForm(url, param, (res)=>{
                    ...
                    if (qInd < 0) {
                        ...
                        if(res.code != 0) {        //和后台约定
                            this.checkWrongNum();//判断输入错误次数
                            Vue.utils.showTips('账户或密码错误');
                        }else{
                ...
                // if (this.shareCode8 && res.code == -8) {
                //     Vue.cookie.delCookie("shareCode8");
                //     Vue.cookie.setCookie("shareMessageTip", res.message);
                //     location.href="/invite-fail.html";
                //     return;
                // }
                // if(this.shareCode8){
                //     Vue.cookie.delCookie("shareCode8");
                //     returnUrl="/invite-success.html";
                // }
                ...
                (res)=>{
                    ...
                    if(this.startImgCode) {//密码输错，刷新图片验证码
                        this.updImgCode();
                    }
                    ...
                    Vue.api.postForm(url, param, (res) => {
                        ...
                        if(this.shareCode8){
                        	Vue.cookie.delCookie("shareCode8");
                            returnUrl = config.contextPath + "/invite-success.html";
                        }
                        location.replace(returnUrl);                      
                    }, (res) => {
                        this.getInit();
        ...
        regis:function(){ 
            var url = "regis.html";
            if (urlParams.setName){
                url="regis.html?shareCode="+urlParams.shareCode+"&setName="+urlParams.setName;
            }
            location=url;
        },    
        qlogin: function () {
            ...
            if(!/^(13|15|17|18|14)[0-9]{9}$/.test(this.user.mobile)) {
            ...
            if(this.user.startImgCode) {//需要图形验证码
                param = {
                    ...
                    companyId: Vue.mallSettings.getCompanyId(),
                    checkImageCode: this.user.checkImageCode,
                    identityTypeCode: 4,
                    initType: 0
        ...
        smsSend: function (param) {
            ...
            if(!mobile || !/^(13|15|17|18|14)[0-9]{9}$/.test(mobile)) {
